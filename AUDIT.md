...
> complete through `CBIND-035F4`: the graphics-resource, texture, vertex/index buffer, effect and
...
> stage-addressed texture collections, frame control and buffer binding. The generated inventory
> currently records 3,288 implemented, 23 partial, 3,031 planned and 73
