...
| 703 | Populate the window handle at window creation and clear it at destruction (mirror FNA `SDL3_FNAPlatform.cs:463–465`); currently never assigned. Use `TextInputEXT::setWindowHandleProperty(handle)` (property as of Task 707) | ⬜ | |
