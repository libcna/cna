...
**11a complete (Tasks 11.1-11.9); 11b complete (Tasks 11.10-11.12); 11c underway (Tasks 11.13/11.14 done, 11.15 not started).** Added after the user decided CNA should actually have avatars, and that the real
