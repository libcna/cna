...
namespace Microsoft::Xna::Framework::Audio
{
    ...
    protected:
        /**
         * @brief Releases this wave bank's resources, optionally only the native ones.
         *
         * The documented protected disposal hook: `Dispose()` routes here, and a derived class
         * overrides this rather than the public method, so one path releases the wave bank however it
         ...
         * `using WaveBank::Dispose;`, because declaring the name hides the public
