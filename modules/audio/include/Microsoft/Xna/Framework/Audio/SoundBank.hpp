...
namespace Microsoft::Xna::Framework::Audio
{
    ...
    protected:
        /**
         * @brief Releases this sound bank's resources, optionally only the native ones.
         *
         * The documented protected disposal hook: `Dispose()` routes here, and a derived class
         * overrides this rather than the public method, so one path releases the sound bank however it
         ...
         * `using SoundBank::Dispose;`, because declaring the name hides the public
