...
// NANOVG's own equivalent of modules/graphics/examples/unsupported_3d_call_behavior_test.cpp
// (Canvas/FreeDirect/OpenVG/SDL_Renderer's shared fixture), covering the identical ground --
// Unsupported3DGraphicsCallBehavior::Throw/WarnAndStub on every inherently-3D-only entry point --
// but reflecting NANOVG's actually-honest GraphicsCapability::Texture3D=false, which the shared
// fixture's Texture3D expectations assume is true.
//
...
class NanoVgUnsupported3DBehaviorTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        Check(device.SupportsCapability(CNA::GraphicsCapability::AdditiveBlending),
              "AdditiveBlending capability honestly true (a real capability edge over OPENVG)");
...
public:
    NanoVgUnsupported3DBehaviorTest()
    {
...
int main()
{
    ...
    NanoVgUnsupported3DBehaviorTest game;
    game.Run();
    return fail == 0 ? 0 : 1;
}
