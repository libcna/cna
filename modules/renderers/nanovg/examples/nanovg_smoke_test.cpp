...
// Vertical-slice smoke test for the NANOVG renderer: selection -> initialization -> resource
// creation -> real rendering -> present -> readback -> cleanup, all through genuine `nvg*` NanoVG
// entry points (see docs/nanovg-renderer.md).
//
...
class NanoVgSmokeTest : public CNA::Examples::PixelTestGame
{
...
int main()
{
    return CNA::Examples::RunPixelTest<NanoVgSmokeTest>();
}
