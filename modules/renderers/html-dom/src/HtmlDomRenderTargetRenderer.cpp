...
{
    HtmlDomRenderTargetRenderer::HtmlDomRenderTargetRenderer(int w, int h)
        : texture_(w, h)
    {
    }

    HtmlDomRenderTargetRenderer::~HtmlDomRenderTargetRenderer()
    {
    ...
    void HtmlDomRenderTargetRenderer::BindAsRenderTarget()
    {
        SetBoundRenderTargetIdEXT(texture_.GetCanvasId());
    }

    void HtmlDomRenderTargetRenderer::UnbindAsRenderTarget()
    {
    ...
    bool HtmlDomRenderTargetRenderer::GetData(int level, int x, int y, int w, int h,
                                             void* data, int dataLength) const
    {
        ...
        if (level > 0)
            throw System::NotSupportedException(
                "HtmlDomRenderTargetRenderer::GetData: this renderer has no mip chain; level " +
