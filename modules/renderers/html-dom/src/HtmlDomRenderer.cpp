...
//
// The canvas itself is hidden but deliberately NOT removed or display:none'd -- the platform keeps
// sizing it and delivering input through it, so it has to stay in the layout. `contain:strict` keeps the
