...
// a Dx5Renderer pointer. All real <ddraw.h> usage lives in Dx5Renderer.cpp behind the
// Impl pimpl below.
...
{
    /**
     * DX5 graphics renderer (plan_dx5.md): a mechanical port of Dx3Renderer (plan_dx3.md,
     * itself a port of Dx2Renderer, plan_dx2.md), upgraded to DirectDraw v4
     ...
     * (Dx5TextureRenderer/Dx5RenderTargetRenderer, defined entirely in Dx5Renderer.cpp --
     ...
     * (Dx5SpriteBatchRenderer): IDirectDrawSurface4::Blt/BltFast has never supported rotation in any
     ...
     */
    class Dx5Renderer final : public IGraphicsRenderer
    {
    public:
        explicit Dx5Renderer(const GraphicsRendererCreateArgs& args);
        ~Dx5Renderer() override;

        Dx5Renderer(const Dx5Renderer&) = delete;
        Dx5Renderer& operator=(const Dx5Renderer&) = delete;
        ...
        // Phase O5 (design decision 8): plain CPU-side storage (Dx5VertexBufferRenderer/
        // Dx5IndexBufferRenderer, defined entirely in Dx5Renderer.cpp), matching the
