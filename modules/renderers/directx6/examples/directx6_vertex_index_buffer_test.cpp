...
// plans/plan_dx2.md Phase O5 (DX2-40..DX2-42): DirectX6VertexBufferRenderer/DirectX6IndexBufferRenderer CTest.
...
class DirectX6VertexIndexBufferTest : public Game
{
...
int main()
{
    DirectX6VertexIndexBufferTest game;
    game.Run();
