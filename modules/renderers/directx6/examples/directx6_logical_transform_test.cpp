...
// letterbox scale+offset) tests for the DIRECTX6 (real DirectDraw v4, run under Wine -- no
...
class DirectX6LogicalTransformTest : public Game
{
...
int main()
{
    DirectX6LogicalTransformTest game;
    game.Run();
