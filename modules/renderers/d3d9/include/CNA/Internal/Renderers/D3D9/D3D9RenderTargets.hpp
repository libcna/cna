...
//
// Both classes hold a non-owning D3D9Renderer* (owner_) -- a render target's Unbind must be
...
// IDirect3D9::CheckDeviceMultiSampleType() reports (D3D9Renderer::ClampMultiSampleCountEXT()),
...
namespace CNA::Internal::Renderers::D3D9
{
    ...
    {
    public:
        D3D9RenderTargetRenderer(D3D9Renderer& owner, IDirect3DDevice9* device,
        ...
        /// them, without also binding this target -- an MRT bind (D3D9Renderer::
    ...
    {
    public:
        D3D9RenderTargetCubeRenderer(D3D9Renderer& owner, IDirect3DDevice9* device,
