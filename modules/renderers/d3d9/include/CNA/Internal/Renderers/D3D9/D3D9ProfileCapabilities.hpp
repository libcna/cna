...
namespace CNA::Internal::Renderers::D3D9
{
     ...
     * pre-device-creation capability probe -- the same call D3D9Renderer's own constructor
     ...
     * D3D9Renderer::ClampMultiSampleCountEXT already uses at a live device's own
