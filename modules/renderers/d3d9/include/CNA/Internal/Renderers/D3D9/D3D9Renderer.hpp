...
namespace CNA::Internal::Renderers::D3D9
{
     ...
     */
    class D3D9Renderer final : public IGraphicsRenderer
    {
    public:
        explicit D3D9Renderer(const GraphicsRendererCreateArgs& args);
        ...
        /// surface). Found empirically via this renderer's own Check T (D3D9_Smoke); tracked here
        ...
        /// own UnbindAsRenderTarget(). NOXNA (mirrors D3D11Renderer::RestoreBackBufferRenderTargetEXT()).
        ...
        /// `D3D11Renderer`'s own identical fallback). Defined in `D3D9InstancedDraw.cpp`.
        ...
        /// vs_2_0/ps_2_0 under Reach. Mirrors D3D11Renderer::CreateEffectRenderer()'s own
        ...
        /// creation path (NOXNA, mirrors D3D11Renderer::GetDeviceEXT()).
    ...
    private:
        ...
        /// dedicated declaration (mirrors D3D11Renderer::GetOrCreateInstancedInputLayoutEXT()).
        ...
        /// `D3D11Renderer::DrawPrimitivesExImpl`'s own flag priority-cascade) and dispatches
        ...
        /// (mirrors D3D11Renderer::currentCustomRT_'s identical lifetime reasoning). MRT
        ...
        /// (mirrors D3D11Renderer::inputLayoutCache_'s shape). See
