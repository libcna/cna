...
// NOT survive a device Reset() automatically; they register with the owning D3D9Renderer
...
namespace CNA::Internal::Renderers::D3D9
{
    ...
    {
    public:
        D3D9VertexBufferRenderer(D3D9Renderer& owner, IDirect3DDevice9* device, int vertex_capacity);
    ...
    inline void RequireFaithfulDeclarationEXT(const IVertexBufferRenderer& vb, const char* route)
    {
        ...
        CNA::Internal::Graphics::RequireFaithfulVertexDeclaration(
            ...
            CNA::Internal::Graphics::UnlistedStrideLayout::RendererRefusesIt, "D3D9", route);
    }
    ...
    {
    public:
        D3D9IndexBufferRenderer(D3D9Renderer& owner, IDirect3DDevice9* device,
