...
//   ...) round-trips through DirectX5TextureRenderer::UpdatePixels (Lock()/memcpy/Unlock()) without
//   throwing (DX2-20/21).
...
class DirectX5TextureRenderTargetTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // CNA_RENDERER_DIRECTX9-only) -- an honest, documented gap for DIRECTX5 (and DIRECTX2/DIRECTX3, its own porting sources), not silently dropped.
        {
            bool threw = false;
...
public:
    DirectX5TextureRenderTargetTest()
    {
...
int main()
{
    DirectX5TextureRenderTargetTest game;
    game.Run();
