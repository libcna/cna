...
// plans/plan_dx2.md Phase O4 (DX2-30..DX2-35): the real proof DIRECTX5's (a port of DIRECTX3's own, itself a port of DIRECTX2's) CPU transform/clip -> D3DTLVERTEX
...
// to IGraphicsRenderer::DrawPrimitivesEx() -- DirectX5Renderer's own override, built on the same
...
// safe D3DCULL_NONE default (see DirectX5Renderer.cpp's Create3DDevice), so this test's own
...
class DirectX5ColoredPrimitivesTest : public Game
{
...
int main()
{
    DirectX5ColoredPrimitivesTest game;
    game.Run();
