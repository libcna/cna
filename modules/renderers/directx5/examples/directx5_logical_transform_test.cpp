...
// letterbox scale+offset) tests for the DIRECTX5 (real DirectDraw v4, run under Wine -- no
...
class DirectX5LogicalTransformTest : public Game
{
...
int main()
{
    DirectX5LogicalTransformTest game;
    game.Run();
