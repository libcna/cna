...
// TextureAddressMode (Wrap/Mirror/Clamp) sampling tests for the DIRECTX5 (DirectDraw v4, via
...
// blend-formula concern (DX2-40..44, already covered by DirectX5_Blend).
//
...
class DirectX5SamplingTest : public Game
{
