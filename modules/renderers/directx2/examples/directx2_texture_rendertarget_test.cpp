...
//   ...) round-trips through DirectX2TextureRenderer::UpdatePixels (Lock()/memcpy/Unlock()) without
//   throwing (DX2-20/21).
...
class DirectX2TextureRenderTargetTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // CNA_RENDERER_DIRECTX9-only) -- an honest, documented gap for DIRECTX2, not silently dropped.
        {
            bool threw = false;
...
public:
    DirectX2TextureRenderTargetTest()
    {
...
int main()
{
    DirectX2TextureRenderTargetTest game;
    game.Run();
