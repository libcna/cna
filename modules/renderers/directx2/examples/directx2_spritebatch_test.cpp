...
class DirectX2SpriteBatchTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // Check J: custom Effect throws.
        {
            ...
            check(threw, "Begin() with a non-null custom Effect throws (no shader stage on DIRECTX2)");
        }
