...
// confirmed D3DFILL_WIREFRAME genuinely renders edge-only output here (see DirectX2Renderer.hpp's
...
class DirectX2GraphicsCapabilityTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        auto& renderer = static_cast<CNA::Internal::Renderers::DirectX2::DirectX2Renderer&>(dev.GetRenderer());
        ...
        // above) is real DIRECTX2 boundary: DirectDraw has exactly one active render target.
...
public:
    DirectX2GraphicsCapabilityTest()
    {
...
int main()
{
    DirectX2GraphicsCapabilityTest game;
    game.Run();
