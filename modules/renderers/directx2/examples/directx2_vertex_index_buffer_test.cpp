...
// plans/plan_dx2.md Phase O5 (DX2-40..DX2-42): DirectX2VertexBufferRenderer/DirectX2IndexBufferRenderer CTest.
...
class DirectX2VertexIndexBufferTest : public Game
{
...
int main()
{
    DirectX2VertexIndexBufferTest game;
    game.Run();
