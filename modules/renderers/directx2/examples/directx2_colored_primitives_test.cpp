...
// plans/plan_dx2.md Phase O4 (DX2-30..DX2-35): the real proof DIRECTX2's CPU transform/clip -> D3DTLVERTEX
...
// to IGraphicsRenderer::DrawPrimitivesEx() -- DirectX2Renderer's own override, built on the same
...
// safe D3DCULL_NONE default (see DirectX2Renderer.cpp's Create3DDevice), so this test's own
...
class DirectX2ColoredPrimitivesTest : public Game
{
...
int main()
{
    DirectX2ColoredPrimitivesTest game;
    game.Run();
