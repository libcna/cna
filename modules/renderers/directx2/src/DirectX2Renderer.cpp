...
namespace CNA::Internal::Renderers::DirectX2
{
    ...
    {
        if (!args.window) throw std::runtime_error("DirectX2Renderer initialized with null window.");
        ...
        if (!impl_->hwnd)
            throw std::runtime_error("DirectX2Renderer: could not obtain a real HWND from the SDL window.");
