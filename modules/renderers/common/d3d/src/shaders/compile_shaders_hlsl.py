...
SHADERS = [
    ...
    ("lit_textured3d.vert.hlsl",     "main", "vs_5_0", "kLitTextured3dColoredVertDxbc", "CNA_LIT_VERTEX_COLOR_INPUT"),
    ("lit_textured3d.vert.hlsl",     "main", "vs_5_0", "kLitUntextured3dVertDxbc", "CNA_LIT_UNTEXTURED_INPUT"),
    ("lit_textured3d.frag.hlsl",     "main", "ps_5_0", "kLitTextured3dFragDxbc"),
    ("lit_textured3d.frag.hlsl",     "main", "ps_5_0", "kLitTextured3dColoredFragDxbc", "CNA_LIT_VERTEX_COLOR_INPUT"),
    ("lit_textured3d_vertexlit.vert.hlsl", "main", "vs_5_0", "kLitTextured3dVertexLitVertDxbc"),
    ("lit_textured3d_vertexlit.vert.hlsl", "main", "vs_5_0", "kLitTextured3dVertexLitColoredVertDxbc", "CNA_LIT_VERTEX_COLOR_INPUT"),
    ...
    ("dual_texture3d.vert.hlsl",     "main", "vs_5_0", "kDualTextureDualUv3dVertDxbc", "CNA_DUAL_TEXTURE_DUAL_UV_INPUT"),
    ("dual_texture3d.vert.hlsl",     "main", "vs_5_0", "kDualTextureColored3dVertDxbc", "CNA_DUAL_TEXTURE_COLOR_INPUT"),
    ("dual_texture3d.vert.hlsl",     "main", "vs_5_0", "kDualTextureColoredDualUv3dVertDxbc", "CNA_DUAL_TEXTURE_COLOR_INPUT", "CNA_DUAL_TEXTURE_DUAL_UV_INPUT"),
