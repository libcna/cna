...
int main()
{
    ...
    try
    {
        ...
        const auto plain = reinterpret_cast<PlainFn>(
            CNA::Internal::Renderers::Glide::ResolveGlideExport(module, "GlideAbiPlainProbe", 0));
        const auto stdcall = reinterpret_cast<StdcallFn>(
            CNA::Internal::Renderers::Glide::ResolveGlideExport(module, "GlideAbiStdcallProbe", 4));
        ...
        reinterpret_cast<VoidFn>(
            CNA::Internal::Renderers::Glide::ResolveGlideExport(module, "FakeGlideReset", 0))();
        CNA::Internal::Renderers::Glide::Abi::GlideApiFunctions glide;
        glide.Resolve(module);

        using namespace CNA::Internal::Renderers::Glide::Abi;
        ...
        const auto callMask = reinterpret_cast<MaskFn>(
            CNA::Internal::Renderers::Glide::ResolveGlideExport(module, "FakeGlideCallMask", 0));
        ...
        try
        {
            static_cast<void>(CNA::Internal::Renderers::Glide::ResolveGlideExport(module, "MissingGlideProbe", 0));
        }
