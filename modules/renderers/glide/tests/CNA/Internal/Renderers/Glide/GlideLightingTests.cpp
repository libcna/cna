...
using CNA::Internal::Renderers::Glide::ApplyGlideBasicEffectFog;
using CNA::Internal::Renderers::Glide::ComposeGlideBasicEffectLitColor;
using CNA::Internal::Renderers::Glide::DotGlideLightingVectors;
using CNA::Internal::Renderers::Glide::EvaluateGlideBasicEffectLighting;
using CNA::Internal::Renderers::Glide::GlideBasicEffectLightingState;
using CNA::Internal::Renderers::Glide::GlideLightingVector;
using CNA::Internal::Renderers::Glide::InvertGlideLightingWorld3x3;
using CNA::Internal::Renderers::Glide::TransformGlideLightingNormal;
