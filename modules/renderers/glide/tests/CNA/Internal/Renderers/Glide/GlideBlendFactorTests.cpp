...
using CNA::Internal::Renderers::Glide::GlideBlendFactorNeedsAuxiliaryAlpha;
using CNA::Internal::Renderers::Glide::GlideBlendFactorsNeedAuxiliaryAlpha;
using CNA::Internal::Renderers::Glide::GlideBlendSlot;
using CNA::Internal::Renderers::Glide::kGlideBlendAlphaSaturate;
using CNA::Internal::Renderers::Glide::kGlideBlendDestinationAlpha;
using CNA::Internal::Renderers::Glide::kGlideBlendInverseDestinationAlpha;
using CNA::Internal::Renderers::Glide::kGlideBlendInverseSourceAlpha;
using CNA::Internal::Renderers::Glide::kGlideBlendInverseSourceColor;
using CNA::Internal::Renderers::Glide::kGlideBlendOne;
using CNA::Internal::Renderers::Glide::kGlideBlendSourceAlpha;
using CNA::Internal::Renderers::Glide::kGlideBlendSourceColor;
using CNA::Internal::Renderers::Glide::kGlideBlendZero;
using CNA::Internal::Renderers::Glide::ToGlideBlendFactor;
