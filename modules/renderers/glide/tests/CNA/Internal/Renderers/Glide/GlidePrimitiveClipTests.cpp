...
using CNA::Internal::Renderers::Glide::ClipGlidePolygonToFrustum;
using CNA::Internal::Renderers::Glide::ClipGlideSegmentToFrustum;
using CNA::Internal::Renderers::Glide::GlideClipVertex;
using CNA::Internal::Renderers::Glide::HasFiniteGlideClipCoordinates;
using CNA::Internal::Renderers::Glide::IsGlidePointInsideFrustum;
using CNA::Internal::Renderers::Glide::kGlideMinimumPositiveClipW;
