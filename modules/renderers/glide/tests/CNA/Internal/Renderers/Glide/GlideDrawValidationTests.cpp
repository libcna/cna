...
using CNA::Internal::Renderers::Glide::MakeGlideExpandedIndexedDrawParams;
using CNA::Internal::Renderers::Glide::ValidateGlideDualSamplerAddressModes;
using CNA::Internal::Renderers::Glide::ValidateGlideSamplerMipState;
using CNA::Internal::Renderers::Glide::ValidateGlideVertexStreams;
using Microsoft::Xna::Framework::Graphics::VertexDeclaration;

namespace
{
    class TestVertexBuffer final : public IVertexBufferRenderer
    {
    public:
    ...
    GpuDrawParams ValidSingleStream(const IVertexBufferRenderer* buffer)
    {
