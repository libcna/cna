...
using CNA::Internal::Backends::Glide::GlideResolutionCandidate;
using CNA::Internal::Backends::Glide::KnownGlideDisplayMode;
using CNA::Internal::Backends::Glide::kGlideRefresh60Hz;
using CNA::Internal::Backends::Glide::SelectGlideDisplayMode;
