...
#include "CNA/Internal/Renderers/Glide/GlideAbiLoader.hpp"

#include <cstddef>
#include <cstdint>

namespace CNA::Internal::Renderers::Glide::Abi
{
    ...
    /**
     * The hand-declared subset of the public Glide 3.x ABI that the native renderer uses. CNA
    ...
    /**
     * Resolved function pointers for every Glide entry point used by the renderer.
     *
