    ...
    [[nodiscard]] inline int ToGlideBlendFactor(Microsoft::Xna::Framework::Graphics::Blend blend, GlideBlendSlot slot)
    {
        ...
        switch (blend)
        {
            ...
            case Blend::SourceColor:
                if (isSourceSlot)
                {
                    throw std::runtime_error(
                        "GLIDE backend cannot use Blend::SourceColor as a source blend factor: "
            ...
            case Blend::InverseSourceColor:
                ...
                {
                    throw std::runtime_error(
                        "GLIDE backend cannot use Blend::InverseSourceColor as a source blend factor: "
                        "Glide's source-factor argument slot can only reference the destination colour");
                }
            ...
            case Blend::DestinationColor:
                ...
                {
                    throw std::runtime_error(
                        "GLIDE backend cannot use Blend::DestinationColor as a destination blend factor: "
            ...
            case Blend::InverseDestinationColor:
                ...
                {
                    throw std::runtime_error(
                        "GLIDE backend cannot use Blend::InverseDestinationColor as a destination blend "
            ...
            case Blend::SourceAlphaSaturation:
                ...
                {
                    throw std::runtime_error(
                        "GLIDE backend cannot use Blend::SourceAlphaSaturation as a destination blend "
