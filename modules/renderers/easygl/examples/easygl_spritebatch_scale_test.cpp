...
// Task 418: EasyGL SpriteBatch scalar/Vector2 scale overload pixel test.
//
...
// source rectangle (SpriteBatch.cpp: destRect.Width/Height = sourceRect.Width/Height * scale).
//
...
//
//   (100,100) -> Red   : well inside the scalar-scaled 60x60 box.
//   (115, 80) -> Green : just past the scalar box's real right edge (110); a too-large scale
//                        (or ignored scale, sprite would stay 20x20) would wrongly show Red here.
//   (220,110) -> Red   : inside the correct 40x80 box; a "scale.X used for both axes" bug (40x40,
//                        edge y=90) would wrongly show Green here (110 > 90).
//   (245, 70) -> Green : just past the correct box's real right edge (240); a "scale.Y used for
//                        both axes" bug (80x80, edge x=280) would wrongly show Red here.
//   ( 50,250) -> Green : far from both sprites, pure background sanity check.
//
...
class SpriteBatchScaleTest : public Game
{
