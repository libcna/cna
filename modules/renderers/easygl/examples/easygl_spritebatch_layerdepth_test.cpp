...
// which sprite is VISIBLE on screen where 2 opaque sprites overlap. This scene deliberately uses
// FNA's default DepthStencilState.None, so the sprite drawn LAST in the sorted sequence wins by
// painter's algorithm. SOFTWARE-337 separately proves that layerDepth is also retained in vertex
// Z and participates in depth testing when a caller explicitly enables it.
//
