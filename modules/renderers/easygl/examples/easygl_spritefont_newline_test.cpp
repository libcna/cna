...
// from the glyph's own 8px height, so a bug that advances by glyph height instead of the font's
// real lineSpacing_ would be caught (not just coincidentally pass). Drawing "A\nA" at position
// (2,2):
...
class EasyGLSpriteFontNewlineTest : public Game
{
...
int main()
{
    EasyGLSpriteFontNewlineTest game;
    game.Run();
