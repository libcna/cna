...
// letterbox scale+offset) tests for the DIRECTX7 (real DirectDraw v4, run under Wine -- no
...
class DirectX7LogicalTransformTest : public Game
{
...
int main()
{
    DirectX7LogicalTransformTest game;
    game.Run();
