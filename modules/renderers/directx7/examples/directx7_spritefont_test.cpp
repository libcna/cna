...
// plans/plan_dx2.md Phase O2 (DX2-13, 2D layer ported from DX1-50..DX1-54): SpriteFont / DrawString tests for the DIRECTX7 (real
...
// a color-match tolerance to work around that renderer's own physical/logical scaling), DIRECTX7's CPU
...
class DirectX7SpriteFontTest : public Game
{
