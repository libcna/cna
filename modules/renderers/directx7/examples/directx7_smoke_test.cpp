...
//
// Check A -- GetWindowInternal() returns a real, non-null window (DIRECTX7 needs a genuine Win32 HWND,
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // Check A: real window.
        check(renderer.GetWindowInternal() != nullptr, "GraphicsDevice has a real window under the DIRECTX7 renderer");
