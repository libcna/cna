...
// the DIRECTX7 (real DirectDraw v4, run under Wine -- no ../free-direct anywhere in this renderer)
...
// actually happened: DirectX7Renderer's constructor unconditionally throws if
...
//
// Check A -- GameWindow handle returns a real, non-null window (DIRECTX7 needs a genuine Win32 HWND,
...
//   (RGB and alpha), read from DIRECTX7's own Lockable shadow-backbuffer surface (design decision 4).
...
class DirectX7SmokeTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // Check A: real window.
        check(reinterpret_cast<SDL_Window*>(getWindowProperty().getHandleProperty()) != nullptr, "GraphicsDevice has a real window under the DIRECTX7 renderer");
