...
// TextureAddressMode (Wrap/Mirror/Clamp) sampling tests for the DIRECTX7 (DirectDraw v4, via
...
// blend-formula concern (DX2-40..44, already covered by DirectX7_Blend).
//
...
class DirectX7SamplingTest : public Game
{
