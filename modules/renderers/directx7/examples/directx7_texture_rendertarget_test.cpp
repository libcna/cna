...
//   ...) round-trips through DirectX7TextureRenderer::UpdatePixels (Lock()/memcpy/Unlock()) without
//   throwing (DX2-20/21).
...
class DirectX7TextureRenderTargetTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // CNA_RENDERER_DIRECTX9-only) -- an honest, documented gap for DIRECTX7 (and DIRECTX2/DIRECTX3, its own porting sources), not silently dropped.
        {
            bool threw = false;
...
public:
    DirectX7TextureRenderTargetTest()
    {
...
int main()
{
    DirectX7TextureRenderTargetTest game;
    game.Run();
