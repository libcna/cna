...
protected:
    void RunTest() override
    {
        ...
        customBlend.setAlphaSourceBlendProperty(Blend::One);
        customBlend.setAlphaDestinationBlendProperty(Blend::One);
        ...
        Check(customBlendNative.blendEnabled &&
                  ...
                  customBlendNative.alphaSourceBlend == kOne &&
                  customBlendNative.alphaDestinationBlend == kOne &&
        ...
        RasterizerState unclipped = clipped;
        unclipped.setScissorTestEnableProperty(false);
        device.setRasterizerStateProperty(unclipped);
        ...
        DepthStencilState depthAlways = depthNever;
        depthAlways.setDepthBufferFunctionProperty(CompareFunction::Always);
        device.setDepthStencilStateProperty(depthAlways);
        draw(white);
