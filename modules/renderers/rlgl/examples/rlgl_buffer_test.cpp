...
protected:
    void RunTest() override
    {
        ...
        Check(noOverwriteVertexSnapshot.id == dynamicVertexId &&
                  ...
                  noOverwriteVertexSnapshot.count == 4 &&
                  noOverwriteVertexSnapshot.ordinaryUploadCount == 2 &&
        ...
        Check(noOverwrite16.id == index16Id && noOverwrite16.indexBuffer &&
                  ...
                  noOverwrite16.ordinaryUploadCount == 3 &&
                  noOverwrite16.noOverwriteUploadCount == 0 &&
              ...
              "partial 16-bit NoOverwrite composes and preserves fixed-capacity tail data");
        ...
        Check(discarded16.id == index16Id && discarded16.nativeByteSize == 12 &&
                  discarded16.ordinaryUploadCount == 4 &&
                  discarded16.discardUploadCount == 0 &&
                  PrefixEquals(discarded16.nativeBytes, replacement16.data(), 2) &&
                  IsZeroTail(discarded16.cpuBytes, 4),
              "partial 16-bit Discard clears the unwritten fixed-capacity storage");
        ...
        Check(discarded32.id == index32Id && discarded32.indexBuffer &&
                  ...
                  discarded32.ordinaryUploadCount == 3 &&
                  discarded32.discardUploadCount == 0 &&
                  PrefixEquals(discarded32.nativeBytes, replacement32.data(), 2) &&
                  IsZeroTail(discarded32.cpuBytes, 8),
              "partial 32-bit Discard preserves values beyond the unsigned-short range");
