...
namespace CNA::Internal::Renderers::D3D12
{
    ...
    {
    public:
        D3D12VertexBufferRenderer(D3D12Renderer* renderer, int vertex_capacity);
    ...
    inline void RequireFaithfulDeclarationEXT(const IVertexBufferRenderer& vb, const char* route)
    {
        ...
        CNA::Internal::Graphics::RequireFaithfulVertexDeclaration(
            ...
            CNA::Internal::Graphics::UnlistedStrideLayout::RendererRefusesIt, "D3D12", route);
    }
    ...
    {
    public:
        D3D12IndexBufferRenderer(D3D12Renderer* renderer, int index_capacity, bool thirtyTwoBit);
