...
namespace CNA::Internal::Renderers::D3D12
{
    ...
    {
    public:
        D3D12RenderTargetRenderer(D3D12Renderer* owner, ID3D12Device* device,
        ...
        /// two-concrete-type resolution, mirroring D3D11Renderer::GetSrvForTextureEXT).
    ...
    {
    public:
        D3D12RenderTargetCubeRenderer(D3D12Renderer* owner, ID3D12Device* device,
