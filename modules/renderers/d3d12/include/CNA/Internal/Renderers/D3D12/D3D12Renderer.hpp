...
namespace CNA::Internal::Renderers::D3D12
{
     ...
     */
    class D3D12Renderer final : public IGraphicsRenderer
    {
    public:
        ...
        explicit D3D12Renderer(const GraphicsRendererCreateArgs& args);
        ...
        /// D3D11Renderer::CreateEffectRenderer's own convention: if both sources are
        ...
        /// D3D11Renderer's own `if (currentDSV_)` behavior. @p what names the calling variant
        /// for error messages.
        ...
        /// lit_textured3d/alpha_test3d -- mirrors D3D11Renderer::DrawPrimitivesEx's own
        ...
        /// D3D11Renderer::DrawInstancedPrimitivesEx's own fallback (no per-instance VB means
         ...
         *  GetDeviceRemovedReason() -- mirrors D3D11Renderer::CheckDeviceRemoved's own
         ...
         *  D3D11Renderer::RestoreBackBufferRenderTargetEXT(). NOXNA. */
    ...
    private:
        ...
        /// float4 rows, per-instance, slot 1) -- mirrors D3D11Renderer's own
        ...
        /// GpuDrawParams texture slot -- mirrors D3D11Renderer's own GetSrvForTextureEXT,
        ...
        /// @p ib may be null for the non-indexed path (mirrors D3D11Renderer's own
        ...
        // DX-116: Present() policy state -- mirrors D3D11Renderer's own vsyncEnabled_/
        ...
        // D3D11Renderer's own currentCustomRT_ exactly -- SetRenderTarget2D(nullptr) needs
