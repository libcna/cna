...
// plan_freedirect.md Phase X1/X2: FreeDirect (formerly DX3) renderer skeleton + real DirectDraw (via the ../free-direct sibling)
...
namespace CNA::Internal::Renderers::FreeDirect
{
    ...
    /**
     * FreeDirect graphics renderer (formerly DX3; plan_freedirect.md): a CPU 2D compositor that uses free-direct's
