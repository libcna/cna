...
namespace
{
    ...
    void CheckCompiledInputRegisterRangeValidation(SoftwareRenderer& renderer)
    {
        using Probe = CNA::TestSupport::SyntheticInputRegisterProbe;
        constexpr std::array invalidProbes{
            Probe::Pixel11ColorOutOfRange,
            Probe::Pixel11TextureOutOfRange,
            Probe::Pixel14TextureOutOfRange,
            Probe::Pixel20ColorOutOfRange,
            Probe::Pixel20TexCoordOutOfRange,
            Probe::Pixel30OutOfRange,
            Probe::Vertex20OutOfRange,
            Probe::Vertex30OutOfRange,
        };
        ...
        for (const Probe probe : validProbes)
        {
            ...
            Check(accepted, "compiled Effect parser rejected maximum valid input register");
        }
    }
    ...
    void CheckCompiledOutputRegisterSourceValidation(SoftwareRenderer& renderer)
    {
        using Probe = CNA::TestSupport::SyntheticOutputRegisterSourceProbe;
        constexpr std::array invalidProbes{
            Probe::Pixel20Color,
            Probe::Pixel30Depth,
            Probe::Vertex20Raster,
            Probe::Vertex20Color,
            Probe::Vertex20TexCoord,
            Probe::Vertex30Generic,
        };
        std::string acceptedInvalidProbes;
        for (const Probe probe : invalidProbes)
        {
            CNA::TestSupport::SyntheticEffectOptions options;
            options.includeDrawableProgram = true;
            options.outputRegisterSourceProbe = probe;
            const auto bytes = CNA::TestSupport::BuildSyntheticEffect(options);
            bool rejected = false;
            try
            {
        ...
        Check(acceptedInvalidProbes.empty(),
              "compiled Effect parser accepted write-only output-register sources: " +
                  acceptedInvalidProbes);
    }
    ...
    void CheckCompiledSamplerRegisterSourceValidation(SoftwareRenderer& renderer)
    {
        using Probe = CNA::TestSupport::SyntheticSamplerRegisterSourceProbe;
        constexpr std::array invalidProbes{
            Probe::Pixel20,
            Probe::Pixel30,
            Probe::Vertex30,
        ...
        for (const Probe probe : invalidProbes)
        {
            ...
            options.includeDrawableProgram = true;
            options.includeSampler = true;
            options.samplerRegisterSourceProbe = probe;
            const auto bytes = CNA::TestSupport::BuildSyntheticEffect(options);
            bool rejected = false;
            try
            {
        ...
        Check(acceptedInvalidProbes.empty(),
              "compiled Effect parser accepted direct sampler-register source probes: " +
                  acceptedInvalidProbes);
    }
    ...
    void CheckCompiledSpecialControlSourceValidation(SoftwareRenderer& renderer)
    {
        using Probe = CNA::TestSupport::SyntheticSpecialControlSourceProbe;
        constexpr std::array invalidProbes{
            Probe::PixelPredicate,
            Probe::PixelLabel,
            Probe::PixelLoop,
            Probe::VertexPredicate,
            Probe::VertexLabel,
            Probe::VertexLoop,
        };
        std::string acceptedInvalidProbes;
        for (const Probe probe : invalidProbes)
        {
            CNA::TestSupport::SyntheticEffectOptions options;
            options.includeDrawableProgram = true;
            options.specialControlSourceProbe = probe;
            const auto bytes = CNA::TestSupport::BuildSyntheticEffect(options);
            bool rejected = false;
            try
            {
    ...
    void CheckCompiledPixel1CoissueValidation(SoftwareRenderer& renderer)
    {
        ...
        Check(acceptedInvalidProbes.empty(),
              "compiled Effect parser accepted invalid ps_1_x co-issue probes: " +
                  acceptedInvalidProbes);
        ...
        for (const Probe probe : {Probe::Pixel11RgbThenAlpha, Probe::Pixel11AlphaThenRgb})
        {
            ...
            Check(accepted,
                  "compiled Effect parser rejected a valid ps_1_x co-issue order, probe " +
                      std::to_string(static_cast<int>(probe)));
        }
    }
