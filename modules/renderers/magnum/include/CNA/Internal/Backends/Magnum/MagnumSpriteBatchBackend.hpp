...
namespace CNA::Internal::Backends::Magnum
{
    ...
    public:
         ...
         *
         * @param graphicsBackend Backend that owns this batch, consulted for the destination
         *                        extent the sprite projection is built from.
         */
        explicit MagnumSpriteBatchBackend(MagnumGraphicsBackend* graphicsBackend);
        ~MagnumSpriteBatchBackend() override = default;
         ...
         *                             backend, whose batches are drawn in submission order.
         */
        void Draw(const ITextureBackend& texture,
                  const Rectangle& destinationRectangle,
                  const Rectangle& sourceRectangle,
    ...
    private:
        ...
        MagnumGraphicsBackend* graphicsBackend_ = nullptr;
