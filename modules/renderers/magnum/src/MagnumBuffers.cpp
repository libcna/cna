...
namespace CNA::Internal::Renderers::Magnum
{
    ...
    std::vector<MagnumVertexAttribute> StockAttributesForStride(std::size_t strideInBytes)
    {
        switch (strideInBytes)
        {
            ...
            // plans/plan_gltf.md GLTF-462/GLTF-465: stride 60 is the rigid PBR record with a second UV set
            ...
            // plans/plan_gltf.md GLTF-463: stride 80 is stride 68's skinned PBR record with the second UV
