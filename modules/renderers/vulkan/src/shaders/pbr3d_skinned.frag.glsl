...
layout(set = 0, binding = 9) uniform samplerCube uIblIrradiance;
layout(set = 0, binding = 10) uniform samplerCube uIblSpecular;
layout(set = 0, binding = 11) uniform sampler2D uIblBrdfLut;
