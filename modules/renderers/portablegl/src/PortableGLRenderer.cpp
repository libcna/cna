...
namespace CNA::Internal::Renderers
{
    ...
    namespace PortableGL { std::unique_ptr<IGraphicsRenderer> CreateGraphicsRenderer(const GraphicsRendererCreateArgs& args); }

    std::unique_ptr<IGraphicsRenderer> PortableGL::CreateGraphicsRenderer(const GraphicsRendererCreateArgs& args)
    {
