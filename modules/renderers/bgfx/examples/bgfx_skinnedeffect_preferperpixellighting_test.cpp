...
// Task 1104 (plans/plan_graphics.md Phase 80 / plans/plan_dx9.md Divergence 1): SkinnedEffect pixel test --
...
// re-evaluated per fragment. Before this task, this renderer's SkinnedEffect path always evaluated
