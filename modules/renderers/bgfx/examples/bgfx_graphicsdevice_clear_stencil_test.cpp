...
//
// Method: stamp the whole screen to stencil=0x07 in frame N via a real draw
...
class BgfxGraphicsDeviceClearStencilTest : public Game
{
...
public:
    BgfxGraphicsDeviceClearStencilTest()
    {
...
int main()
{
    BgfxGraphicsDeviceClearStencilTest game;
    game.Run();
