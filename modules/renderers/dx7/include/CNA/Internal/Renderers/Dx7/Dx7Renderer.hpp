...
// plan_dx7.md: real DirectX 7 graphics renderer -- genuinely new interfaces vs DX6:
...
// a Dx7Renderer pointer. All real <ddraw.h> usage lives in Dx7Renderer.cpp behind the
// Impl pimpl below.
...
{
    /**
     * DX7 graphics renderer (plan_dx7.md): a port of Dx6Renderer (plan_dx6.md, itself a
     * port of Dx5/Dx3/Dx2Renderer), upgraded to DirectDraw v7
     ...
     * (Dx7TextureRenderer/Dx7RenderTargetRenderer, defined entirely in Dx7Renderer.cpp --
     ...
     * (Dx7SpriteBatchRenderer): IDirectDrawSurface7::Blt/BltFast has never supported rotation in any
     ...
     */
    class Dx7Renderer final : public IGraphicsRenderer
    {
    public:
        explicit Dx7Renderer(const GraphicsRendererCreateArgs& args);
        ~Dx7Renderer() override;

        Dx7Renderer(const Dx7Renderer&) = delete;
        Dx7Renderer& operator=(const Dx7Renderer&) = delete;
        ...
        // Phase O5 (design decision 8): plain CPU-side storage (Dx7VertexBufferRenderer/
        // Dx7IndexBufferRenderer, defined entirely in Dx7Renderer.cpp), matching the
