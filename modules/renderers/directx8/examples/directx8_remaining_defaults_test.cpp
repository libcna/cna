...
//   cube textures are DIRECTX8/DIRECTX8+).
...
class DirectX8RemainingDefaultsTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        check(renderer.CreateTexture3D(2, 2, 2, false, 0) == nullptr &&
              ...
              "CreateTexture3D/CreateTextureCube/CreateRenderTargetCube all return nullptr (DIRECTX8/DIRECTX8+ features)");
...
int main()
{
    DirectX8RemainingDefaultsTest game;
    game.Run();
