...
// TextureAddressMode (Wrap/Mirror/Clamp) sampling tests for the DIRECTX8 (DirectDraw v4, via
...
// blend-formula concern (DX2-40..44, already covered by DirectX8_Blend).
//
...
class DirectX8SamplingTest : public Game
{
