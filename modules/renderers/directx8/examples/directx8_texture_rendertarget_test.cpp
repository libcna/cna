...
//   ...) round-trips through DirectX8TextureRenderer::UpdatePixels (Lock()/memcpy/Unlock()) without
//   throwing (DX2-20/21).
...
class DirectX8TextureRenderTargetTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // CNA_RENDERER_DIRECTX9-only) -- an honest, documented gap for DIRECTX8 (and DIRECTX2/DIRECTX3, its own porting sources), not silently dropped.
        {
            bool threw = false;
...
public:
    DirectX8TextureRenderTargetTest()
    {
...
int main()
{
    DirectX8TextureRenderTargetTest game;
    game.Run();
