...
// plans/plan_dx2.md Phase O5 (DX2-40..DX2-42): DirectX8VertexBufferRenderer/DirectX8IndexBufferRenderer CTest.
...
class DirectX8VertexIndexBufferTest : public Game
{
...
int main()
{
    DirectX8VertexIndexBufferTest game;
    game.Run();
