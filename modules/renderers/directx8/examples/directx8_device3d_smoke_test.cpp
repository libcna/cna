...
// directx8_ztest_test.cpp/etc, and real stencil write-then-test is covered by directx8_stencil_test.cpp, not
...
//   stencil) with all three flags) does not throw and clears color correctly -- DIRECTX8's stencil
...
//   directx8_stencil_test.cpp is the dedicated real stencil write/test proof.
// Check D -- SetDepthTestEnabled/SetDepthWriteEnabled no longer throw -- a smoke-level check;
//   DirectX8_ZTest covers real depth-test pixel behavior.
//
...
class DirectX8Device3DSmokeTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // color correctly; DIRECTX8's stencil clear is real (see directx8_stencil_test.cpp for the
...
int main()
{
    DirectX8Device3DSmokeTest game;
    game.Run();
