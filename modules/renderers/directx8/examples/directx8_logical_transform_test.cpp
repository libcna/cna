...
// letterbox scale+offset) tests for the DIRECTX8 (real DirectDraw v4, run under Wine -- no
...
class DirectX8LogicalTransformTest : public Game
{
...
int main()
{
    DirectX8LogicalTransformTest game;
    game.Run();
