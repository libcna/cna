...
//
// Check A -- GameWindow handle returns a real, non-null window (DIRECTX8 needs a genuine Win32 HWND,
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // Check A: real window.
        check(reinterpret_cast<SDL_Window*>(getWindowProperty().getHandleProperty()) != nullptr, "GraphicsDevice has a real window under the DIRECTX8 renderer");
