...
// plans/plan_dx2.md Phase O4 (DX2-34, DX2-38): real Direct3D texture sampling in a 3D draw -- a
// DirectX8TextureRenderer surface bound directly via IDirect3DDevice7::SetTexture (plans/plan_dx8.md design
...
class DirectX8Texture3DTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        Check(Close(nearTopLeft.getRProperty(), 255, 10) && Close(nearTopLeft.getGProperty(), 0, 10) &&
              ...
              "via a direct IDirect3DDevice7::SetTexture bind (no texture-handle indirection)");
