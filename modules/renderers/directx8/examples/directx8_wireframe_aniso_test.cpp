...
//
// Check A -- SupportsCapability(WireFrame)==true, SupportsCapability(AnisotropicFiltering)==true
//   (unlike DX2-DIRECTX7's own software rasterizer, DIRECTX8 runs on a real GPU via DXVK).
...
class DirectX8WireframeAnisoTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        Check(dev.SupportsCapability(GraphicsCapability::AnisotropicFiltering),
              "Check A2: SupportsCapability(AnisotropicFiltering)==true (real GPU via DXVK, unlike DX2-DIRECTX7)");
...
int main()
{
    DirectX8WireframeAnisoTest game;
    game.Run();
