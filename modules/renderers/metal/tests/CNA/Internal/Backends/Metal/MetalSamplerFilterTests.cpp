...
// machine. No #if defined(CNA_BACKEND_METAL) gate, deliberately.
//
...
// EasyGLGraphicsBackend::ApplySamplerState()'s own already-shipping GL filter table (read directly
...
TEST(MetalSamplerFilter, AnisotropicIsAllLinearLikePlainLinear)
{
    ...
    // Linear/Linear/Linear base filter, matching EasyGLGraphicsBackend::ApplySamplerState()'s own
