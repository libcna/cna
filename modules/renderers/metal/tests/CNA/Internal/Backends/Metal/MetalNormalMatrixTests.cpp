...
// arrays, basic arithmetic), so unlike the rest of the Metal backend it compiles and runs on any
// platform CnaTests already builds for -- no #if defined(CNA_BACKEND_METAL) gate, deliberately.
//
