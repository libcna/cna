...
namespace CNA::Internal::Backends::OpenGL1
{
     ...
     * OpenGL1GraphicsBackend::DebugSimulateContextLoss()/DebugRestoreContext() (desktop GL has no
    ...
    /**
     * @brief Tracks every IOpenGL1Recoverable resource owned by one OPENGL1 backend instance.
     *
     * One instance lives on OpenGL1GraphicsBackend; resources register themselves at
     * construction (when context recovery is enabled -- see
     * IGraphicsBackend::SetContextRecoveryEnabled()) and unregister at destruction.
     */
