...
{
    /// Luminance-ordered glyph-density ramp used by the ASCII renderer's BlackWhite/Color
     ...
     * GraphicsDevice/Texture2D dependency, usable directly via IGraphicsRenderer::CreateTexture()
     * from inside a renderer itself (Phase G5's Present() needs this; BuildAsciiFontAtlas() below
