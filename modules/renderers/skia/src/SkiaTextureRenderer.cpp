...
namespace CNA::Internal::Renderers::Skia
{
    ...
    SkiaTextureRenderer::SkiaTextureRenderer(const ImageData& data,
    ...
    SkiaTextureRenderer::~SkiaTextureRenderer()
    {
        if (resourceRegistered_)
            resourceCounters_->RemoveTexture(imageViewStorageBytes_);
    }

    void SkiaTextureRenderer::UpdatePixels(const std::uint8_t* rgba, int stride)
    {
        if (!rgba)
    ...
    void SkiaTextureRenderer::UpdatePixelsLevel(int level, const std::uint8_t* rgba,
    ...
    bool SkiaTextureRenderer::GetData(int level, int x, int y, int width, int height,
    ...
    sk_sp<SkImage> SkiaTextureRenderer::SnapshotImage(
    ...
    sk_sp<SkImage> SkiaTextureRenderer::SnapshotMipLevelEXT(
    ...
    void SkiaTextureRenderer::RebuildImage()
    {
        if (compressedChain_)
        {
    ...
    std::uint64_t SkiaTextureRenderer::MipGenerationCountEXT(int level) const
    {
        if (compressedChain_)
        {
    ...
    void SkiaTextureRenderer::InvalidateGeneratedDescendants(int level)
    {
    ...
    void SkiaTextureRenderer::GenerateDirtyMipLevels()
    {
    ...
    void SkiaTextureRenderer::GenerateMipLevel(int level)
    {
