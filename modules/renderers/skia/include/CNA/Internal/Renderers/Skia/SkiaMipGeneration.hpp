...
{
    // Shared little-endian primitives (SKIA-142): used by both SkiaTextureRenderer's transfer
     ...
     * generic packed UNORM). Shared by SkiaTextureRenderer and SkiaRenderTargetRenderer (SKIA-142)
