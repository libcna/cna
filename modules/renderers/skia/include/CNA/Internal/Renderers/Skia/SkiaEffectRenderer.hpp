...
namespace CNA::Internal::Renderers::Skia
{
     ...
     *
     * ShaderEffect's two strings are renderer-specific opaque payloads. Existing EasyGL content
    ...
    class SkiaEffectRenderer final : public IEffectRenderer
    {
    public:
        ~SkiaEffectRenderer() override;
    ...
    private:
        ...
        std::weak_ptr<ITextureCubeRenderer> boundCubeRenderer_;
        std::weak_ptr<ITexture3DRenderer> boundVolumeRenderer_;
    };
} // namespace CNA::Internal::Renderers::Skia
