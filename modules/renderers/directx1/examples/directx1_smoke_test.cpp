...
// plans/plan_dx1.md Phase O1/O2 (DX1-1..DX1-18): smoke test for the DIRECTX1 (real DirectDraw v1, run under
...
// directx1_spritebatch_test.cpp (Phase O4).
//
// Check A -- GameWindow handle returns a real, non-null window (DIRECTX1 needs a genuine Win32 HWND,
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // Check A: real window.
        check(reinterpret_cast<SDL_Window*>(getWindowProperty().getHandleProperty()) != nullptr, "GraphicsDevice has a real window under the DIRECTX1 renderer");
