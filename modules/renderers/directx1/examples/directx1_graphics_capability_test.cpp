...
// DIRECTX1 (DirectDraw, 2D-only by design) supports none of the currently-enumerated capabilities,
...
class DirectX1GraphicsCapabilityTest : public Game
{
...
public:
    DirectX1GraphicsCapabilityTest()
    {
...
int main()
{
    DirectX1GraphicsCapabilityTest game;
    game.Run();
