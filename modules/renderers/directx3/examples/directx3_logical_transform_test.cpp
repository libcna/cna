...
// letterbox scale+offset) tests for the DIRECTX3 (real DirectDraw v2, run under Wine -- no
...
class DirectX3LogicalTransformTest : public Game
{
...
int main()
{
    DirectX3LogicalTransformTest game;
    game.Run();
