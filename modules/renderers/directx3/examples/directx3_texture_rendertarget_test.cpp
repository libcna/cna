...
//   ...) round-trips through DirectX3TextureRenderer::UpdatePixels (Lock()/memcpy/Unlock()) without
//   throwing (DX2-20/21).
...
class DirectX3TextureRenderTargetTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // CNA_RENDERER_DIRECTX9-only) -- an honest, documented gap for DIRECTX3 (and DIRECTX2, its own porting source), not silently dropped.
        {
            bool threw = false;
...
public:
    DirectX3TextureRenderTargetTest()
    {
...
int main()
{
    DirectX3TextureRenderTargetTest game;
    game.Run();
