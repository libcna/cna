...
//   is real) -- a smoke-level check; DirectX3_ZTest covers real depth-test pixel behavior.
//
...
class DirectX3Device3DSmokeTest : public Game
{
...
int main()
{
    DirectX3Device3DSmokeTest game;
    game.Run();
