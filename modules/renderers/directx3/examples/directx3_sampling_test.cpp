...
// TextureAddressMode (Wrap/Mirror/Clamp) sampling tests for the DIRECTX3 (DirectDraw v2, via
...
// blend-formula concern (DX2-40..44, already covered by DirectX3_Blend).
//
...
class DirectX3SamplingTest : public Game
{
