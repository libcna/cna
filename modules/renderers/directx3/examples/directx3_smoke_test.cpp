...
// the DIRECTX3 (real DirectDraw v2, run under Wine -- no ../free-direct anywhere in this renderer)
...
// actually happened: DirectX3Renderer's constructor unconditionally throws if
...
class DirectX3SmokeTest : public Game
{
