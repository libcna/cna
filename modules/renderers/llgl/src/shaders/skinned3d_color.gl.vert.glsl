...
// SkinnedEffect.VertexColorEnabled vertex shader, OpenGL flavour. LLGL-37. See
// skinned3d_color.vert.glsl for the Vulkan flavour and why this is a separate shader from
// skinned3d.gl.vert.glsl.
...
layout(std140, binding = 1) uniform SkinnedParams
{
    ...
    mat4 worldMatrix;
    vec4 diffuseColor;
    vec4 emissiveColorPad; // .w > 0.5 when VertexColorEnabled is true.
    vec4 light0DirPad;
