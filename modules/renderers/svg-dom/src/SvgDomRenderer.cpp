...
// plan_svg_dom.md design decision 1/6: creates the SVG surface over the platform-owned <canvas> --
// the same host-integration shape as HtmlDom's own root (canvas stays in the layout, hidden, so the
// platform keeps sizing it and delivering input through it), but the surface
