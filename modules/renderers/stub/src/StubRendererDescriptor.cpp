// plans/plan_runtimerenderer.md RTR-P1-D09: the Stub family's pre-construction contract.
//
// Deliberately minimal no-op renderer (plans/plan_stub.md design decision 1): renders nothing, touches no
