...
// plan_dx.md Phase DX5 (DX-30/DX-31): real D3D11 vertex/index buffer renderers.
//
// Both renderers hold their own Microsoft::WRL::ComPtr<ID3D11Device>/ComPtr<ID3D11DeviceContext>
// (copied/AddRef'd from D3D11Renderer, design decision 10) rather than a raw owner pointer
...
namespace CNA::Internal::Renderers::D3D11
{
    ...
    inline void RequireFaithfulDeclarationEXT(const IVertexBufferRenderer& vb, const char* route)
    {
        ...
        CNA::Internal::Graphics::RequireFaithfulVertexDeclaration(
            ...
            CNA::Internal::Graphics::UnlistedStrideLayout::RendererRefusesIt, "D3D11", route);
    }
