...
namespace CNA::Internal::Renderers::D3D11
{
     ...
     */
    class D3D11Renderer final : public IGraphicsRenderer
    {
    public:
        explicit D3D11Renderer(const GraphicsRendererCreateArgs& args);
        ~D3D11Renderer() override;

        D3D11Renderer(const D3D11Renderer&) = delete;
        D3D11Renderer& operator=(const D3D11Renderer&) = delete;

        // ---- IGraphicsRenderer: real (Phase DX4) ----
        ...
        // ---- IGraphicsRenderer: real (Phase DX5) ----
        ...
        // ---- IGraphicsRenderer: real (Phase DX6) ----
        ...
        // ---- IGraphicsRenderer: real (Phase DX8, DX-58 -- custom ShaderEffect) ----
        std::unique_ptr<IEffectRenderer> CreateEffectRenderer(const std::string& vertSrc,
                                                             const std::string& fragSrc) override;

        // ---- IGraphicsRenderer: real (Phase DX7) ----
        ...
        // ---- IGraphicsRenderer: real (Phase DX8, DX-61) ----
        ...
        // ---- IGraphicsRenderer: real (Phase DX8, DX-62/DX-63/DX-64/DX-69-partial) ----
        ...
        // ---- IGraphicsRenderer: real (Phase DX8, DX-68 -- instanced3d) ----
