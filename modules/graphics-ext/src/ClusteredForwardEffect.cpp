            ...
            return ShaderPackageEXT(
                {
                    ...
                    ShaderCodeEXT(CNA::ShaderLanguageEXT::GlslDesktop,
                                  CNA::ShaderStageEXT::Vertex, "main",
                                  "clustered_forward/forward.desktop.vert.glsl",
                                  std::string(kForwardDesktopVertexSource)),
                    ShaderCodeEXT(CNA::ShaderLanguageEXT::GlslDesktop,
                                  CNA::ShaderStageEXT::Fragment, "main",
                                  "clustered_forward/forward.desktop.frag.glsl",
                                  std::string(kForwardDesktopFragmentSource)),
