...
{
    vec2 sourceSize = pc.uUpscaleParams.xy;
...
void main()
{
    ...
    vec2 position = TexCoord * pc.uUpscaleParams.xy - 0.5;
    ...
    if (pc.uUpscaleParams.z > 0.0)
    {
        ...
        vec3 sharpened = upscaled + (upscaled - neighbourhood) * pc.uUpscaleParams.z;
