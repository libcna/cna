...
TEST(EngineLayerVersionTest, TheCurrentRevisionIsFourAndNeverGoesBackwards)
{
    ...
    EXPECT_EQ(CNA_CNAEXT_ENGINE_VERSION, 4);
...
TEST(EngineLayerVersionTest, TheStringFormIsStableAndCarriesTheNumber)
{
    ...
    EXPECT_EQ(CNA::Graphics::getEngineLayerVersionString(), "CNA engine layer 4");
}
