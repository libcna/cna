...
TEST(EngineLayerVersionTest, TheCurrentRevisionIsSixAndNeverGoesBackwards)
{
    ...
    EXPECT_EQ(CNA_CNAEXT_ENGINE_VERSION, 6);
...
TEST(EngineLayerVersionTest, TheStringFormIsStableAndCarriesTheNumber)
{
    ...
    EXPECT_EQ(CNA::Graphics::getEngineLayerVersionString(), "CNA engine layer 6");
}
