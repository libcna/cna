...
TEST(EngineLayerVersionTest, TheCurrentRevisionIsNineteenAndNeverGoesBackwards)
{
    ...
    EXPECT_EQ(CNA_CNAEXT_ENGINE_VERSION, 19);
...
TEST(EngineLayerVersionTest, TheStringFormIsStableAndCarriesTheNumber)
{
    ...
    EXPECT_EQ(CNA::Graphics::getEngineLayerVersionString(), "CNA engine layer 19");
}
