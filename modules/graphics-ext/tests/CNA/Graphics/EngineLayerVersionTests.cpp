...
TEST(EngineLayerVersionTest, TheCurrentRevisionIsNineAndNeverGoesBackwards)
{
    ...
    EXPECT_EQ(CNA_CNAEXT_ENGINE_VERSION, 9);
...
TEST(EngineLayerVersionTest, TheStringFormIsStableAndCarriesTheNumber)
{
    ...
    EXPECT_EQ(CNA::Graphics::getEngineLayerVersionString(), "CNA engine layer 9");
}
