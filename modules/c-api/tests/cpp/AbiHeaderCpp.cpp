...
static_assert(CNA_ABI_VERSION == CNA_ABI_VERSION_ENCODE(0, 23, 0));
...
static_assert(CNA_RENDERER_FEATURE_MAXIMUM == UINT32_C(29));
...
static_assert(CNA_RENDERER_LIMIT_MAXIMUM == UINT32_C(9));
