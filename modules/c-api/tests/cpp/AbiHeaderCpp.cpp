...
static_assert(sizeof(CNA_RendererFeature) == sizeof(uint32_t));
static_assert(CNA_RENDERER_FEATURE_THREE_DIMENSIONAL_PIPELINE == UINT32_C(0));
...
static_assert(CNA_SHADER_DIALECT_SPIRV == UINT32_C(7));
static_assert(CNA_SHADER_DIALECT_MAXIMUM == UINT32_C(7));
static_assert(sizeof(CNA_RendererFeatureSupport) == sizeof(uint32_t));
static_assert(CNA_RENDERER_FEATURE_SUPPORT_UNKNOWN == UINT32_C(0));
static_assert(CNA_RENDERER_FEATURE_SUPPORT_RESTRICTED == UINT32_C(3));
static_assert(sizeof(CNA_RendererLimit) == sizeof(uint32_t));
static_assert(CNA_RENDERER_LIMIT_MAX_TEXTURE_DIMENSION == UINT32_C(0));
static_assert(CNA_RENDERER_LIMIT_MAX_VERTEX_SHADER_STORAGE_BLOCKS == UINT32_C(9));
static_assert(CNA_RENDERER_LIMIT_TIMESTAMP_PERIOD_PICOSECONDS == UINT32_C(21));
static_assert(CNA_RENDERER_LIMIT_MAXIMUM == UINT32_C(21));
static_assert(sizeof(CNA_RendererFormatUsageFlags) == sizeof(uint32_t));
static_assert(CNA_RENDERER_FORMAT_USAGE_COLOR_TRANSFER == (UINT32_C(1) << 12));
static_assert(CNA_RENDERER_FORMAT_USAGE_ALL == UINT32_C(0x1fff));
...
static_assert(CNA_GRAPHICS_RENDERER_VULKAN == UINT32_C(8));
static_assert(CNA_GRAPHICS_RENDERER_FREEDIRECT == UINT32_C(21));
static_assert(CNA_GRAPHICS_RENDERER_SDL_GPU == UINT32_C(31));
static_assert(CNA_GRAPHICS_RENDERER_OPENGL4 == UINT32_C(33));
static_assert(CNA_GRAPHICS_RENDERER_GDI == UINT32_C(40));
static_assert(CNA_GRAPHICS_RENDERER_SVG_DOM == UINT32_C(44));
static_assert(CNA_GRAPHICS_RENDERER_PORTABLEGL == UINT32_C(46));
static_assert(CNA_GRAPHICS_RENDERER_MAXIMUM == CNA_GRAPHICS_RENDERER_PORTABLEGL);
...
static_assert(sizeof(CNA_DeviceType) == sizeof(uint32_t));
static_assert(sizeof(CNA_PowerState) == sizeof(uint32_t));
static_assert(CNA_DEVICE_TYPE_DEVICE == UINT32_C(0));
static_assert(CNA_DEVICE_TYPE_EMULATOR == UINT32_C(1));
static_assert(CNA_DEVICE_TYPE_MAXIMUM == CNA_DEVICE_TYPE_EMULATOR);
...
static_assert(sizeof(CNA_CnbChunkId) == sizeof(uint32_t));
static_assert(sizeof(CNA_CnbCompression) == sizeof(uint32_t));
static_assert(CNA_CNB_COMPRESSION_MAXIMUM == UINT32_C(3));
static_assert(CNA_CNB_FORMAT_HEADER_SIZE == UINT32_C(64));
static_assert(CNA_CNB_FORMAT_TOC_ENTRY_SIZE == UINT32_C(48));
static_assert(CNA_CNB_CONTAINER_CHUNK_METADATA == UINT32_C(0x54454D43));
static_assert(CNA_CNB_ASSET_TYPE_CUSTOM_RANGE_FIRST == UINT32_C(0x80000000));
static_assert(CNA_CNB_CRC32C_SEED == UINT32_C(0));
static_assert(sizeof(CNA_CnbReadLimits) == 48U);
static_assert(alignof(CNA_CnbReadLimits) == 8U);
