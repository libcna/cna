...
// PROCESS ISOLATION
// -----------------
// Each leg runs in its own child process, so the SIGSEGV this ticket is about cannot destroy the
...
#include <sys/wait.h>
#include <unistd.h>
#define CNA_GFX186_CAN_ISOLATE 1
#elif defined(_WIN32)
#include "common/WindowsProcessIsolation.hpp"
#define CNA_GFX186_CAN_ISOLATE 1
#else
#define CNA_GFX186_CAN_ISOLATE 0
#endif
