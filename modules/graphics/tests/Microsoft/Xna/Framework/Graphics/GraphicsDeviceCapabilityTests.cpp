...
// EasyGL, Vulkan and DirectX 11/12 all pull MojoShader in only as an extra, off-by-default dependency
// none of them otherwise needs (CNA_SDL_GPU_COMPILED_EFFECTS / CNA_EASYGL_COMPILED_EFFECTS /
// CNA_VULKAN_COMPILED_EFFECTS / CNA_DIRECTX11_COMPILED_EFFECTS /
// CNA_DIRECTX12_COMPILED_EFFECTS) -- selecting the renderer alone is not enough to expect the
// capability true for any of those five.
