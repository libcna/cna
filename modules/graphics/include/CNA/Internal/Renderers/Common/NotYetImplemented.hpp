...
// plan_dx9.md D9-11: a small shared "loud, explicit failure" helper for renderer methods that are
// not implemented yet. D3D12Renderer already had an identical private static helper of its
// own (D3D12Renderer::NotYetImplemented); rather than duplicate it a second time for D3D9,
...
namespace CNA::Internal::Renderers
{
     ...
     *
     * @param rendererName Short renderer identifier, e.g. "D3D9".
