...
namespace Microsoft::Xna::Framework::Graphics
{
    ...
    protected:
        /**
         * @brief Constructs a DualTextureEffect that is a clone of @p cloneSource.
         *
         * XNA's `protected DualTextureEffect(DualTextureEffect cloneSource)`: the constructor `Clone()`
         ...
         */
        DualTextureEffect(const DualTextureEffect& cloneSource);
