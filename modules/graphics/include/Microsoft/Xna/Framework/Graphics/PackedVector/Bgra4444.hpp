...
namespace Microsoft::Xna::Framework::Graphics::PackedVector
{
    ...
    struct Bgra4444 : public IPackedVectorT<uint16_t>
    {
         ...
         * @return @c true if @p obj holds an equal Bgra4444; @c false otherwise.
         */
        [[nodiscard]] bool Equals(const std::any& obj) const
        {
            const Bgra4444* other = std::any_cast<Bgra4444>(&obj);
            return other != nullptr && Equals(*other);
        }

        /**
         * @brief Compares this value with another Bgra4444 for equality.
         * @param other The Bgra4444 to compare against.
         * @return @c true if both packed values are equal; @c false otherwise.
         */
        [[nodiscard]] bool Equals(const Bgra4444& other) const
        {
