...
namespace Microsoft::Xna::Framework::Graphics::PackedVector
{
    ...
    struct Rgba64 : public IPackedVectorT<uint64_t>
    {
         ...
         * @return @c true if @p obj holds an equal Rgba64; @c false otherwise.
         */
        [[nodiscard]] bool Equals(const std::any& obj) const
        {
            const Rgba64* other = std::any_cast<Rgba64>(&obj);
            return other != nullptr && Equals(*other);
        }

        /**
         * @brief Compares this value with another Rgba64 for equality.
         * @param other The Rgba64 to compare against.
         * @return @c true if both packed values are equal; @c false otherwise.
         */
        [[nodiscard]] bool Equals(const Rgba64& other) const
        {
