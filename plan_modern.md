...
| MOD-1008 | Unit tests for all new math | 🟨 | 15 cases so far, covering everything in `MOD-1000`--`MOD-1004`: the six face orientations, their degeneracy and coverage, the 90-degree square face frustum, the capped size table, the spot view and its factor of two, and every misuse guard on both classes. Left for the reception half: the shader-side lookup math. |
