...
> stock effect family beyond vertex colours (textures, lighting, fog, skinning), render targets,
> cube and volume textures, custom `ShaderEffect`s and occlusion queries are still not implemented.
