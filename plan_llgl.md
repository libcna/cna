...
> checks each. `DualTextureEffect`, `EnvironmentMapEffect`, `SkinnedEffect` and `PbrEffect` are
> still not implemented, nor are cube and volume textures.
