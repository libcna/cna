...
| 1 | `CBIND-042B` define the experimental release gate | ⬜ | a declaration plus a checker; the two open packaging questions must block the release until the owner rules on them |
