...
| 1 | `CBIND-046` offer a static configuration | ⬜ | owner ruled yes on 2026-08-16; the hard part is keeping the ABI promise, since an archive carries every C++ symbol it swallowed |
