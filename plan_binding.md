...
> **Status: IMPLEMENTATION AUTHORIZED — B0–B5 complete; B6 complete through CBIND-035D2 under HEADLESS and SDL_RENDERER (2026-08-15).** This document is
...
| CBIND-035D | Add effects, shaders and parameter coverage | 🟨 | Map Effect/technique/pass/parameter/annotation collections, stock/custom effects and shader/material extensions without exposing bytecode objects, C++ containers or backend pointers. Decomposed into CBIND-035D1–D9; D1–D2 are complete. |
...
and `CBIND-035D1`–`CBIND-035D2` are ✅; parents `CBIND-035` and `CBIND-035D` remain 🟨, while `CBIND-035D3`
...
implemented, 19 partial, 3,940 planned and 70 not applicable, with CBIND-035D3 parameters next.
