...
> desc — not yet part of the cache key. `Clear()`/`Present()`/draw calls remain honest throws —
> `DX-109` (actual vertex/index buffers, textures, render targets) is the next concrete step to
> make a real draw possible.
>
