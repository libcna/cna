...
namespace CNA::Internal::Backends::Magnum
{
    ...
    class MagnumTextureBackend : public ITextureBackend
    {
    public:
        /**
         ...
         */
        explicit MagnumTextureBackend(const ImageData& data);
        ~MagnumTextureBackend() override = default;
    ...
    private:
        // Held indirectly because Magnum's GL object wrappers are move-only and this backend is
    ...
    class MagnumTextureCubeBackend : public ITextureCubeBackend
    {
    public:
        /**
         ...
         */
        MagnumTextureCubeBackend(int size, bool mipMap, int surfaceFormat);
        ~MagnumTextureCubeBackend() override = default;
    ...
    class MagnumTexture3DBackend : public ITexture3DBackend
    {
    public:
        /**
         ...
         *                      today, so the value is recorded rather than honoured.
         */
        MagnumTexture3DBackend(int width, int height, int depth, bool mipMap, int surfaceFormat);
        ~MagnumTexture3DBackend() override = default;
