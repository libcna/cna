...
{
    /**
     * @brief CNA's graphics backend expressed through Magnum's typed OpenGL wrappers.
     *
     * SDL3 stays the window and GL-context owner, exactly as in every other windowed CNA backend;
     ...
     */
    class MagnumGraphicsBackend : public IGraphicsBackend
    {
    public:
        /**
         ...
         */
        MagnumGraphicsBackend(SDL_Window* window,
                              int virtualWidth,
                              int virtualHeight,
                              CnaPresentationMode mode,
                              int multiSampleCount,
                              int swapInterval);
        ~MagnumGraphicsBackend() override;

        /**
         * @brief Reports whether a feature is genuinely available on this backend.
         *
        ...
        /**
         * @brief Sets the virtual (game-logic) resolution the backend presents at.
         *
        ...
        /** @brief The SDL window this backend renders into; never owned. */
        [[nodiscard]] SDL_Window* GetWindowInternal() const override { return window_; }
        /** @brief Always null: this backend renders through OpenGL, not SDL_Renderer. */
        ...
        /** @brief Creates a SpriteBatch backend bound to this graphics backend. */
         ...
         * @return The new effect backend, valid only if compilation succeeded.
         */
    ...
    private:
        ...
        void DrawGeneric(const IVertexBufferBackend& vb,
                         const IIndexBufferBackend* ib,
                         const Matrix& world, const Matrix& view, const Matrix& projection,
                         PrimitiveType primitive, int primitiveCount,
