...
{
    /**
     * @brief Runtime-detected OpenGL version/extension support for the OPENGL1 backend.
     *
     * Computed once, right after the GL context is made current (in
     * OpenGL1GraphicsBackend's constructor), from glGetString(GL_VERSION)/
     ...
     * the extension/capability subset the OPENGL1 backend cares about.
     *
