...
{
    /**
     * @brief Real GPU occlusion queries for the OPENGL1 backend (plan_opengl1.md item 23).
     *
     ...
     * `GL_ANY_SAMPLES_PASSED` implementation (`IOcclusionQueryBackend`'s own doc comment), which
     ...
     */
    class OpenGL1OcclusionQueryBackend final : public IOcclusionQueryBackend
    {
    public:
        OpenGL1OcclusionQueryBackend();
        ~OpenGL1OcclusionQueryBackend() override;
