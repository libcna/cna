...
{
    /**
     * @brief Direct Objective-C++ Metal implementation of CNA's graphics backend contract.
     */
    ...
    public:
         ...
         *
         * @param args Backend creation parameters, including the SDL window and presentation settings.
         */
        explicit MetalGraphicsBackend(const GraphicsBackendCreateArgs& args);
        /** @brief Releases all Metal and SDL resources owned by the backend. */
        ~MetalGraphicsBackend() override;

        /**
         * @brief Metal backends are device-bound and cannot be copied.
         *
         * @param other Backend instance that would otherwise be copied.
         */
        MetalGraphicsBackend(const MetalGraphicsBackend& other) = delete;
        /**
         * @brief Metal backends are device-bound and cannot be copy-assigned.
         *
         * @param other Backend instance that would otherwise be assigned.
         * @return This backend; the operation is deleted and therefore never returns.
         */
        MetalGraphicsBackend& operator=(const MetalGraphicsBackend& other) = delete;
        ...
        /**
         * @brief Returns null because this backend does not use SDL_Renderer.
         *
         * @return Always null.
         */
        ...
        /**
         * @brief Creates an RGBA8 Metal Texture2D backend resource.
         *
         * @param data Initial dimensions and RGBA8 pixel data.
         * @return The newly allocated texture backend.
         */
        std::unique_ptr<ITextureBackend> CreateTexture(const ImageData& data) override;
        /**
         * @brief Creates the built-in direct-Metal SpriteBatch implementation.
         *
         * @return The newly allocated SpriteBatch backend.
         */
         ...
         * @return The newly allocated cube texture backend.
         */
         ...
         * @return The newly allocated render-target backend.
         */
         ...
         * @param mipMap Whether mip storage is requested.
         * @param multiSampleCount Requested XNA multisample count; Metal applies zero.
         * @return The newly allocated cube render-target backend.
         */
         ...
         * @param mipMap Whether mip storage is requested.
         * @param surfaceFormat Requested XNA surface-format value.
         * @return The newly allocated volume-texture backend.
         */
         ...
         * @return The newly allocated vertex-buffer backend.
         */
         ...
         * @return The newly allocated 16-bit index-buffer backend.
         */
         ...
         *
         * @param indexCapacity Initial index capacity.
         * @return The newly allocated 32-bit index-buffer backend.
         */
         ...
         *
         * @param vb Vertex-buffer backend containing the draw data.
         ...
         *
         * @param vb Vertex-buffer backend containing the draw vertices.
         * @param ib Index-buffer backend containing the draw indices.
         * @param world World transform.
         * @param view View transform.
         * @param projection Projection transform.
         * @param primitive Requested primitive topology.
        ...
        struct Impl;
        /**
         * @brief Returns mutable access to the implementation for backend-owned helper objects.
         *
         * @return Mutable implementation storage.
         */
        Impl& impl();
        /**
         * @brief Returns immutable access to the implementation for backend-owned helper objects.
         *
