...
namespace System {
     ...
     * It stores an error message and exposes it through the overridden what()
     * function inherited from std::exception.
     *
     * Instances of this class may be constructed without a message or with
     * either a C-style string or an std::string message.
     * @note Status: Partial
     */
