...
| Software | CPU raster at raw framebuffer pixels; `SetViewport` no-op | ignored | **SEPARATE_FINDING (GFX-073 — now DONE; spawned GFX-079 3D-path DONE, GFX-080 scissor DONE; GFX-081 SpriteBatch rasterizerState-drop / GFX-082 FillMode-ignored NEW)** |
