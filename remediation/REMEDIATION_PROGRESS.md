...
| Software | **3/3 supported contract checks** (Default, None, restored Default); DepthRead recorded but skipped because GFX-030 documents Software v1's fixed-LessEqual/write-on-pass boundary |
