...
>
> Of 460 rows: **366 are closed (`✔` 245, `✅` 121)** and **75 remain `⬜`**; three `✅/⬜` partials
> (`GLTF-064`, `067`, `068`) were completed, `GLTF-388`/`GLTF-449` newly carry one each, and
> `GLTF-439` is now a second `⛔` beside `GLTF-009`. The other 18 carry a
