...
>
> Of 460 rows: **341 are closed (`✔` 220, `✅` 121)** and **102 remain `⬜`**; three `✅/⬜` partials
> (`GLTF-064`, `067`, `068`) were completed, and `GLTF-388`/`GLTF-449` newly carry one each. The other 18 carry a
