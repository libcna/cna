...
>
> Of 460 rows: **371 are closed (`✔` 250, `✅` 121)** and **66 remain `⬜`**. The other 23 carry a
> deliberate partial marker — 8 `🔬` (investigation, no implementation owed), 9 `✅/⬜` and 2
