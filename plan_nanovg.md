...
**Complete**, including three adversarial audit passes: NVG-17 (geometry, presentation, multi-instance
coexistence), NVG-18 (blend, sampler and rasterization semantics) and NVG-19 (Immediate-mode
submission ordering, mip-level refusal, geometric scissor clipping). See
