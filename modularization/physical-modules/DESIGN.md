...
|---|---|---|---|---|
| core | cna_core / CNA::Core (+ cna_core_headers / CNA::CoreHeaders, header-only surface) | src/Core/* | CNA/{CNAException,CNAHelper,DesktopOS,Entrypoint,GraphicsBackendType,LogCategory,Logger,LogLevel,Platform}.hpp; Microsoft/Xna/Framework/{PlayerIndex,NamespaceDocs}.hpp; CNA/Internal/PathContainment.hpp | tests/CNA/LoggerTests.cpp; PlayerIndexTests; PathContainmentTests |
...
| graphics | cna_graphics_core / CNA::GraphicsCore | src/Graphics/{Xna,Internal}/** | Microsoft/.../Graphics/** (+PackedVector, minus the IPackedVector interface -> math); CNA/Internal/Graphics/**; CNA/Internal/Backends/Common/**; CNA/Internal/Utf8Decode.hpp; CNA/{GraphicsCapability,Unsupported3DGraphicsCallBehavior}.hpp; Framework/DisplayOrientation.hpp | tests .../Graphics/** (+PackedVector); tests/CNA/Internal/Graphics/**; tests/CNA/GraphicsBackendTypeTests.cpp; DisplayOrientationTests; GraphicsBackendCompileDefinitionTests; tests/PackedVectorGolden.md |
