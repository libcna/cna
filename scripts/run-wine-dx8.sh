...
# d3d8 DLL override could silently degrade every DX8 pixel test in this suite to validating
...
# a binary that legitimately never creates a DX8 device at all (e.g. a bare --gtest_list_tests
