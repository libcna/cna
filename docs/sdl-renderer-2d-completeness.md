...
| `FromStream` (PNG/JPEG/BMP) and `DDSFromStreamEXT` decode + render | ✅ | Same GPU-upload call site already proven correct by Task 678; verified again end-to-end (Task 682). |
