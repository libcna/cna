...
| `FromStream` (PNG/JPEG/GIF) and `DDSFromStreamEXT` decode + render | ✅ | Same GPU-upload call site already proven correct by Task 678; PNG verified again end-to-end (Task 682), with the classic format boundary shared across renderers. |
