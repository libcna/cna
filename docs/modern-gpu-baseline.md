...
| MOD-2254 | Partial | Float, array, storage-buffer/image, base-instance, indirect, timer/debug, early-disposal and real-resize gates run validation-clean on two devices; swapchain error recovery, stress and sanitizer legs remain. |
