...
| MOD-2254 | Partial | Float, array, storage-buffer/image, base-instance, indirect, timer/debug, early-disposal, real-resize and 2,048-frame allocation-stress gates run validation-clean on two devices; swapchain error recovery and sanitizer legs remain. |
