...
| `Model` constructor root-bone-index flexibility | ✅ fixed (Task 916, 2026-07-09) | ✅ real proof (`DX-155`) — `getRootProperty()` genuinely returns the non-zero-indexed bone, plus a full 5-argument-constructor draw through the real backend | ✅ same proof, off-screen (`DX-155`, Checks VV0/VV1) |
