...
| (hpp:103–122, cpp:67–82) | **missing** | `EasyGLTexture3DRenderer` and `EasyGLTextureCubeRenderer` are not registered with the `ResourceRegistry`. GL context loss orphans their handles — no recovery path exists for 3D and cube textures. |
