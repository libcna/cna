...
### Stable RenderTarget2D mip storage (SKIA-131)
...
pass boundary, while higher authored levels stay isolated. Automatic generation from that rendered
level is intentionally deferred to SKIA-132.
