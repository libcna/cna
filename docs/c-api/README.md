...
Point/Rectangle and complete Vector2/Vector3/Vector4/Quaternion/Matrix/Plane/Ray/BoundingBox/
BoundingSphere operations, packed storage and core draw/buffer/vertex identities, plus
