...
the full generated matrix records all 9,492 public C++
...
|---|---:|---|
| Fully mapped | 8,348 | A C route exists and is tested. |
| **Partially mapped** | 15 | A route exists but covers a stated subset. Read the next section before relying on one. |
| **No C form** | 466 | Nothing callable was omitted; see the reasons below. |
...
### Friendship declarations — 15 symbols
