...
the full generated matrix records all 9,483 public C++
...
|---|---:|---|
| Fully mapped | 8,341 | A C route exists and is tested. |
| **Partially mapped** | 15 | A route exists but covers a stated subset. Read the next section before relying on one. |
| **No C form** | 464 | Nothing callable was omitted; see the reasons below. |
...
### Operations the C++ class deletes — 137 symbols
