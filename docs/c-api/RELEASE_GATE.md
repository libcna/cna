...
**Release:** CNA C ABI 0.8.0, experimental
...
| ✅ | **No unreviewed ABI break** | Every struct layout, field offset, scalar width, constant value and exported symbol is recorded, and a change to any of them arrives as a reviewable diff. | 177 struct layouts and 2862 exported symbols recorded |
