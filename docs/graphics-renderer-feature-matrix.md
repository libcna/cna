...
live window (`plans/plan_dx.md` `DX-102`/`DX-116`), but only via a separate manual diagnostic through a
...
under `DIRECTX11` (`undefined reference to Effect::Apply()`) — found during `plans/plan_dx.md` `DX-81`'s
