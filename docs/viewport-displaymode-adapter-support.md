...
Phase 40 (`GRAPHICS_TASKS.md` Tasks 341–350) audited `Viewport`, `DisplayMode`,
...
project's verify-over-assume standard everywhere else in `GRAPHICS_TASKS.md`.
...
This closes Phase 40 (`GRAPHICS_TASKS.md` Tasks 341–350) in full.
