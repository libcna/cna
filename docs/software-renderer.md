...
`SOFTWARE-162/163/355/356/357/358/360/361/362/363/364/366/368/370/371/373/374/375/376/377/378/379` are complete: the opt-in runtime now includes compiled MRT,
...
- **Classic compiled XNA Effects are not yet executable** (`SOFTWARE-161`). The public bytecode
  ...
  components rather than the ignored raw x/y pair. Invalid marker placement/count, sampled matrix variants and
