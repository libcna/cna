# DX5 (real DirectDraw v4 + Direct3D v3, FVF `DrawPrimitive`) Renderer — Completeness Status

`DX5` is architecturally `DX3` (`docs/dx3-renderer.md`) with two upgrades: (1) *every* surface
...
result in `docs/dx3-renderer.md` (and, two generations back, `docs/dx2-renderer.md`) applies
...
See `docs/dx3-renderer.md` (and, two generations back, `docs/dx2-renderer.md`) for the full
...
- `plan_dx3.md`, `docs/dx3-renderer.md` — the renderer this one ports.
