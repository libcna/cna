...
- CNA applies one narrow, versioned robustness patch to that exact MojoShader revision
  (`cmake/patches/mojoshader-6333f74-effect-parser-robustness.patch`), which turns thirty-seven ways
  untrusted bytecode could crash the process into ordinary parser errors. Thirty-six of the thirty-seven were
