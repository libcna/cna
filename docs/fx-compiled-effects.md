...
- CNA applies one narrow, versioned robustness patch to that exact MojoShader revision
  (`cmake/patches/mojoshader-6333f74-effect-parser-robustness.patch`), which turns twenty-two ways
  untrusted bytecode could crash the process into ordinary parser errors. Twenty-one of the twenty-two were
