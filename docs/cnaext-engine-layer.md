...
generation and stock-effect reception, a portable skybox, thirteen portable post-process consumers,
...
seven-case portable suite passes on EasyGL, RADV and llvmpipe, including a synthetic velocity image
that proves the per-object override without depending on the still source-only Vulkan prepass.
