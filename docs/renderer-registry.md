...
Current as of the eleven-lane renderer integration (2026-08-11): CNA exposes exactly **45 public
...
`docs/ascii-post-process-effect.md`. `OPENGLES2`, `BLEND2D`, `FNA3D`, `SVG_DOM` and `OPENVG` were added. EasyGL is an internal
...
The five GL profiles share one implementation target, macro, and factory, so 45 public identities
map to 41 concrete implementation factories. Their public contracts remain distinct because the
