...
| `MIP-RENDERTARGET2D` | Render, upload, readback and sample mutable target mips. | bounded | SKIA-131–132 | SKIA-131 supplies stable isolated surfaces, exact transfers and real higher-level sampling; SKIA-132 still owns rendered-descendant generation. |
