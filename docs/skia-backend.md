...
6. `cmake/Tests/SkiaTests.cmake` registers twenty-six SKIA-only CTests: one window-independent raster
   surface pixel test and twenty-five display-required public tests. The raster test passes without a
