...
| DualTextureEffect | EasyGL doubling/independent-UV/null/alpha/fog/golden tests; shared fog contract 33/33 | Software samples two slots and applies final-stage alpha-correct fog, but reuses UV0; slot sampler independence is tested | IN-SCOPE-XNA | Partial; independent coordinates remain absent | SOFTWARE-112 ✅ / SOFTWARE-116 | Declaration-driven UV0/UV1 differential; preserve verified formula/alpha/fog. |
...
| SkinnedEffect | EasyGL bones/weights/lighting/specular/fog/world-normal tests; shared fog contract includes post-skin position | Software bone positions and post-skin fog exist; lighting/per-pixel and full normal semantics remain absent | IN-SCOPE-XNA | REAL-GAP outside the now-closed fog slice | SOFTWARE-112 ✅ / SOFTWARE-115 | Preserve fog while adding 1/2/4-weight lit/normal/model probes. |
