...
| AlphaTestEffect | EasyGL modes/compare sweep/fog/vertex-color/diffuse/golden tests; FNA `AlphaTestEffect.fx`; shared alpha and fog contracts pass 30/30 and 32/32 | Software evaluates the encoded comparison after all classic alpha sources and before depth/stencil/colour/fog; fog uses the same perspective-correct stock varying | IN-SCOPE-XNA | ALREADY-PARITY at current evidence level | SOFTWARE-111 ✅ / SOFTWARE-112 ✅ | Preserve compare/source/discard and final fog ordering. |
| DualTextureEffect | EasyGL doubling/independent-UV/null/alpha/fog/golden tests; shared fog contract 32/32 | Software samples two slots and applies final-stage fog, but reuses UV0; slot sampler independence is tested | IN-SCOPE-XNA | Partial; independent coordinates remain absent | SOFTWARE-112 ✅ / SOFTWARE-116 | Declaration-driven UV0/UV1 differential; preserve verified formula/alpha/fog. |
| EnvironmentMapEffect | EasyGL amount/fresnel/eye/world/multilight/specular/fog tests; shared fog contract 32/32 | Software cube reflection and final-stage fog exist; lighting is absent and World normal transform is not inverse-transpose | IN-SCOPE-XNA | REAL-GAP outside the now-closed fog slice | SOFTWARE-112 ✅ / SOFTWARE-114 | Preserve fog while adding focused lighting/reflection/normal-scale probes. |
