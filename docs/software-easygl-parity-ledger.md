...
| EnvironmentMapEffect | EasyGL amount/fresnel/eye/world/multilight/specular/fog tests; shared fog contract 33/33 | Software cube reflection and final-stage alpha-correct fog exist; lighting is absent and World normal transform is not inverse-transpose | IN-SCOPE-XNA | REAL-GAP outside the now-closed fog slice | SOFTWARE-112 ✅ / SOFTWARE-114 | Preserve fog while adding focused lighting/reflection/normal-scale probes. |
