...
- **`SkinnedEffect` only forwards `DirectionalLight0`** — lights 1 and 2 are dropped on all 3 3D
  backends (Task 893). It also has no specular term and `WeightsPerVertex` is a GPU no-op (Tasks
  894/895).
