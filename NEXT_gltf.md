...
- **Working document:** `plan_gltf.md`, 460 numbered rows. **357 closed (`✔` 236, `✅` 121),
  85 `⬜` remaining**, plus `GLTF-388`'s and `GLTF-449`'s new `✅/⬜` partials, plus `GLTF-449`'s new `✅/⬜`. The other 18 carry a deliberate partial marker: 8 `🔬` (investigation, no
