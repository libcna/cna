...
- **Working document:** `plan_gltf.md`, 460 numbered rows. **331 closed (`✔` 210, `✅` 121),
  110 `⬜` remaining**, plus `GLTF-449`'s new `✅/⬜`. The other 18 carry a deliberate partial marker: 8 `🔬` (investigation, no
...
| generator `--check` | **71 assets, 346 files — byte-identical** |
