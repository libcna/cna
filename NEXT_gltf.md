...
- **Working document:** `plan_gltf.md`, 460 numbered rows. **365 closed (`✔` 244, `✅` 121),
  77 `⬜` remaining.** The other 18 carry a deliberate partial marker: 8 `🔬` (investigation, no
...
| generator `--check` | **88 assets, 429 files — byte-identical** |
