...
// DiffuseColor*Alpha*VertexColor, component-wise. This is the `true` branch of the same
// VertexColorEnabled gate Task 364 added to `vs_colored3d.sc` (`v_color0 = vc * u_diffuseColor`,
// `vc = (u_vertexColorEnabled3D.x>0.5) ? a_color0 : vec4(1)`) — the pre-existing multiply Task
...
class BgfxBasicEffectVertexColorEnabledTest : public Game
{
...
public:
    BgfxBasicEffectVertexColorEnabledTest()
    {
...
int main()
{
    BgfxBasicEffectVertexColorEnabledTest game;
    game.Run();
