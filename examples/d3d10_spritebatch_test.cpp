...
// plan_d3d10.md: SpriteBatch tests for the D3D10 backend's real GPU-quad 2D compositor
// (D3D10SpriteBatchBackend -- a real vs_4_0/ps_4_0 shader, orthographic screen-to-clip transform,
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // matches DX8/DX1..DX7's own established rotation-test convention exactly.
        {
            Texture2D tex(dev, 2, 2);
            std::vector<Color> px = {
                Color(255, 0, 0, 255), Color(0, 255, 0, 255),
