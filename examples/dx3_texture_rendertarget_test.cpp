...
//   ...) round-trips through Dx3TextureRenderer::UpdatePixels (Lock()/memcpy/Unlock()) without
//   throwing (DX2-20/21).
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // CNA_RENDERER_D3D9-only) -- an honest, documented gap for DX3 (and DX2, its own porting source), not silently dropped.
        {
            bool threw = false;
