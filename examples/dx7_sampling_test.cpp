...
// TextureAddressMode (Wrap/Mirror/Clamp) sampling tests for the DX7 (DirectDraw v4, via
...
// blend-formula concern (DX2-40..44, already covered by Dx7_Blend).
//
...
class Dx7SamplingTest : public Game
{
