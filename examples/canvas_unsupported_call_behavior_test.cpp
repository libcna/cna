...
// CNA::UnsupportedGraphicsCallBehavior: verifies Canvas's 2D-only "fire and forget" 3D calls
...
// sdlrenderer_unsupported_call_behavior_test.cpp/dx3_unsupported_call_behavior_test.cpp.
//
...
class CanvasUnsupportedCallBehaviorTest : public Game
{
...
public:
    CanvasUnsupportedCallBehaviorTest()
    {
...
int main()
{
    CanvasUnsupportedCallBehaviorTest game;
    game.Run();
