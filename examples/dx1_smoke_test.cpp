...
// plan_dx1.md Phase O1/O2 (DX1-1..DX1-18): smoke test for the DX1 (real DirectDraw v1, run under
...
//
// Check A -- GetWindowInternal() returns a real, non-null window (DX1 needs a genuine Win32 HWND,
...
//   (RGB and alpha), read from DX1's own Lockable shadow-backbuffer surface (design decision 4).
...
class Dx1SmokeTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // Check A: real window.
        check(renderer.GetWindowInternal() != nullptr, "GraphicsDevice has a real window under the DX1 renderer");
