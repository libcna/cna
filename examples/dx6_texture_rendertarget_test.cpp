...
//   ...) round-trips through Dx6TextureBackend::UpdatePixels (Lock()/memcpy/Unlock()) without
//   throwing (DX2-20/21).
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // CNA_BACKEND_D3D9-only) -- an honest, documented gap for DX6 (and DX2/DX30, its own porting sources), not silently dropped.
        {
            bool threw = false;
