...
// plan_dx2.md Phase O3 (DX2-20..DX2-26): smoke test for DX5's real Direct3D v3 device bring-up (a port of DX30's own, itself a port of DX2's) --
...
// confirms the simple state-toggle methods don't throw anymore (a smoke-level check) -- Dx5_ZTest
...
//   is real) -- a smoke-level check; Dx5_ZTest covers real depth-test pixel behavior.
//
...
class Dx5Device3DSmokeTest : public Game
{
