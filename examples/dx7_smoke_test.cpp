...
// the DX7 (real DirectDraw v4, run under Wine -- no ../free-direct anywhere in this renderer)
...
// actually happened: Dx7Renderer's constructor unconditionally throws if
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // Check A: real window.
        check(renderer.GetWindowInternal() != nullptr, "GraphicsDevice has a real window under the DX7 renderer");
