...
// the DIRECTX6 (real DirectDraw v4, run under Wine -- no ../free-direct anywhere in this renderer)
...
// actually happened: DirectX6Renderer's constructor unconditionally throws if
...
//
// Check A -- GetWindowInternal() returns a real, non-null window (DIRECTX6 needs a genuine Win32 HWND,
...
//   (RGB and alpha), read from DIRECTX6's own Lockable shadow-backbuffer surface (design decision 4).
...
class DirectX6SmokeTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // Check A: real window.
        check(renderer.GetWindowInternal() != nullptr, "GraphicsDevice has a real window under the DIRECTX6 renderer");
