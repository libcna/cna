...
// the DX8 (real DirectDraw v4, run under Wine -- no ../free-direct anywhere in this renderer)
...
// actually happened: Dx8Renderer's constructor unconditionally throws if
...
//
// Check A -- GetWindowInternal() returns a real, non-null window (DX8 needs a genuine Win32 HWND,
...
//   (RGB and alpha), read from DX8's own Lockable shadow-backbuffer surface (design decision 4).
...
class Dx8SmokeTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // Check A: real window.
        check(renderer.GetWindowInternal() != nullptr, "GraphicsDevice has a real window under the DX8 renderer");
