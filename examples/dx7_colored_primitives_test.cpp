...
// plan_dx2.md Phase O4 (DX2-30..DX2-35): the real proof DX7's (a port of DX30's own, itself a port of DX2's) CPU transform/clip -> D3DTLVERTEX
...
// to IGraphicsBackend::DrawPrimitivesEx() -- Dx7GraphicsBackend's own override, built on the same
...
// safe D3DCULL_NONE default (see Dx7GraphicsBackend.cpp's Create3DDevice), so this test's own
...
class Dx7ColoredPrimitivesTest : public Game
{
