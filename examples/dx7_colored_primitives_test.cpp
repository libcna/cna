...
// to IGraphicsRenderer::DrawPrimitivesEx() -- Dx7Renderer's own override, built on the same
...
// safe D3DCULL_NONE default (see Dx7Renderer.cpp's Create3DDevice), so this test's own
