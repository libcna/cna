...
//   ...) round-trips through Dx8TextureRenderer::UpdatePixels (Lock()/memcpy/Unlock()) without
//   throwing (DX2-20/21).
...
class Dx8TextureRenderTargetTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // CNA_RENDERER_D3D9-only) -- an honest, documented gap for DX8 (and DX2/DX3, its own porting sources), not silently dropped.
        {
            bool threw = false;
...
int main()
{
    Dx8TextureRenderTargetTest game;
    game.Run();
