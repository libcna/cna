...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // above) is a real DX7 (and DX2/DX30, its own porting sources) boundary: DirectDraw has exactly one active render target.
...
int main()
{
    Dx7GraphicsCapabilityTest game;
    game.Run();
