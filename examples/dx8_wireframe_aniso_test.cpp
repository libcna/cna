...
//   (unlike DX2-DX7's own software rasterizer, DX8 runs on a real GPU via DXVK).
...
class Dx8WireframeAnisoTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        Check(dev.SupportsCapability(GraphicsCapability::AnisotropicFiltering),
              "Check A2: SupportsCapability(AnisotropicFiltering)==true (real GPU via DXVK, unlike DX2-DX7)");
