...
namespace
{
    ...
    // The shared preamble (SkiaCubeSampling.hpp) plus this spike's own minimal wrapper: an author
...
int main()
{
    const auto compiled = SkRuntimeEffect::MakeForShader(SkString(kCubeSamplingSource));
