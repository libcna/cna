...
// confirmed D3DFILL_WIREFRAME genuinely renders edge-only output here (see Dx6Renderer.hpp's
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        auto& renderer = static_cast<CNA::Internal::Renderers::Dx6::Dx6Renderer&>(dev.GetRenderer());
