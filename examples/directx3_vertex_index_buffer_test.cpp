...
// plan_dx2.md Phase O5 (DX2-40..DX2-42): DirectX3VertexBufferRenderer/DirectX3IndexBufferRenderer CTest.
...
using namespace CNA::Internal::Renderers::DirectX3;

static constexpr int kCanvasSize = 64;

class DirectX3VertexIndexBufferTest : public Game
{
...
int main()
{
    DirectX3VertexIndexBufferTest game;
    game.Run();
