...
//
// Check A -- GetWindowInternal() returns a real, non-null window (DX5 needs a genuine Win32 HWND,
...
//   (RGB and alpha), read from DX5's own Lockable shadow-backbuffer surface (design decision 4).
...
class Dx5SmokeTest : public Game
{
