...
// to IGraphicsRenderer::DrawPrimitivesEx() -- Dx8Renderer's own override, built on the same
...
// safe D3DCULL_NONE default (see Dx8Renderer.cpp's Create3DDevice), so this test's own
