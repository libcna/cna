...
// to IGraphicsBackend::DrawPrimitivesEx() -- Dx8GraphicsBackend's own override, built on the same
...
// safe D3DCULL_NONE default (see Dx8GraphicsBackend.cpp's Create3DDevice), so this test's own
...
class Dx8ColoredPrimitivesTest : public Game
{
