...
// plan_dx2.md Phase O3 (DX2-20..DX2-26): smoke test for DX7's real Direct3D v7 device bring-up (a port of DX6's own, itself a port of DX5/DX30/DX2's) --
...
//   stencil) with all three flags) does not throw and clears color correctly -- DX7's stencil
...
//   Dx7_ZTest covers real depth-test pixel behavior.
//
...
class Dx7Device3DSmokeTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // color correctly; DX7's stencil clear is real (see dx7_stencil_test.cpp for the
