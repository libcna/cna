...
// to IGraphicsRenderer::DrawPrimitivesEx() -- Dx5Renderer's own override, built on the same
...
// safe D3DCULL_NONE default (see Dx5Renderer.cpp's Create3DDevice), so this test's own
