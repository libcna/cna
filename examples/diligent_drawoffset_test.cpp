...
//
// plan_diligent.md DILIGENT-45: real-device proof that the Diligent backend honors non-zero
...
// (BasicEffect/GraphicsDevice) and to the vertex formats this backend actually supports (stride 16
