...
// Blend-mode compositing tests for the DIRECTX8 (real Direct3D 8 via DXVK) graphics renderer.
//
// Unlike DX2-DIRECTX7 (DirectDraw-based, no programmable blend hardware -- ApplyBlendState there
// detects which of the 4 XNA BlendState *presets* a caller's factors match and falls back to a
// hardcoded AlphaBlend CPU formula for anything else), DIRECTX8 has REAL Direct3D 8 blend hardware:
...
class DirectX8BlendTest : public Game
{
