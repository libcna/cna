...
// letterbox scale+offset) tests for the DX7 (real DirectDraw v4, run under Wine -- no
...
using namespace CNA::Internal::Renderers::Dx7;
...
class Dx7LogicalTransformTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        auto& renderer = static_cast<Dx7Renderer&>(dev.GetRenderer());
