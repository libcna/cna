...
protected:
    void Initialize() override
    {
        ...
        Check(backend != nullptr
                  ...
                  && backend->MipGenerationCountEXT(1) == 0u
                  && backend->MipGenerationCountEXT(2) == 0u,
        ...
        Check(!backend->HasDefinedMipLevel(-1) && !backend->HasDefinedMipLevel(3)
                  && backend->HasDefinedMipLevel(0) && backend->HasDefinedMipLevel(2),
