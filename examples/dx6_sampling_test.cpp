...
// TextureAddressMode (Wrap/Mirror/Clamp) sampling tests for the DX6 (DirectDraw v4, via
...
// blend-formula concern (DX2-40..44, already covered by Dx6_Blend).
//
...
class Dx6SamplingTest : public Game
{
