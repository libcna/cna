...
//
// Check A -- GetWindowInternal() returns a real, non-null window (DX2 needs a genuine Win32 HWND,
...
//   (RGB and alpha), read from DX2's own Lockable shadow-backbuffer surface (design decision 4).
...
class Dx2SmokeTest : public Game
{
