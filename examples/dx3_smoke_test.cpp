...
// the DX3 (real DirectDraw v2, run under Wine -- no ../free-direct anywhere in this renderer)
...
// actually happened: Dx3Renderer's constructor unconditionally throws if
