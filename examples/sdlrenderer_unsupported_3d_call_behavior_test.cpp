...
// CNA::Unsupported3DGraphicsCallBehavior: verifies SDL_Renderer's 2D-only "fire and forget" 3D
...
class SdlUnsupported3DCallBehaviorTest : public Game
{
...
public:
    SdlUnsupported3DCallBehaviorTest()
    {
...
int main()
{
    SdlUnsupported3DCallBehaviorTest game;
    game.Run();
