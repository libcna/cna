...
// DX1 (DirectDraw, 2D-only by design) supports none of the currently-enumerated capabilities,
...
class Dx1GraphicsCapabilityTest : public Game
{
...
int main()
{
    Dx1GraphicsCapabilityTest game;
    game.Run();
