...
// confirmed D3DFILL_WIREFRAME genuinely renders edge-only output here (see Dx5Renderer.hpp's
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        auto& renderer = static_cast<CNA::Internal::Renderers::Dx5::Dx5Renderer&>(dev.GetRenderer());
