...
// plan_dx2.md Phase O4 (DX2-30..DX2-35): the real proof DX2's CPU transform/clip -> D3DTLVERTEX
...
// to IGraphicsBackend::DrawPrimitivesEx() -- Dx2GraphicsBackend's own override, built on the same
...
// safe D3DCULL_NONE default (see Dx2GraphicsBackend.cpp's Create3DDevice), so this test's own
...
class Dx2ColoredPrimitivesTest : public Game
{
