...
// to IGraphicsRenderer::DrawPrimitivesEx() -- Dx2Renderer's own override, built on the same
...
// safe D3DCULL_NONE default (see Dx2Renderer.cpp's Create3DDevice), so this test's own
