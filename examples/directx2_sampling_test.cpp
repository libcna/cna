...
// TextureAddressMode (Wrap/Mirror/Clamp) sampling tests for the DIRECTX2 (DirectDraw, via the
...
// blend-formula concern (DX2-40..44, already covered by DirectX2_Blend).
//
...
class DirectX2SamplingTest : public Game
{
