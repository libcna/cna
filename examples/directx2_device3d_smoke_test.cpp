...
// plan_dx2.md Phase O3 (DX2-20..DX2-26): smoke test for DIRECTX2's real Direct3D v2 device bring-up --
...
// confirms the simple state-toggle methods don't throw anymore (a smoke-level check) -- DirectX2_ZTest
...
//   is real) -- a smoke-level check; DirectX2_ZTest covers real depth-test pixel behavior.
//
...
using namespace CNA::Internal::Renderers::DirectX2;

static constexpr int kCanvasSize = 64;

class DirectX2Device3DSmokeTest : public Game
{
...
int main()
{
    DirectX2Device3DSmokeTest game;
    game.Run();
