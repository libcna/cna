...
// plan_dx1.md Phase O7 (DX1-68): TransformWindowToLogical/TransformLogicalToWindow (real
// letterbox scale+offset) tests for the DX1 (real DirectDraw v1, run under Wine -- no
...
class Dx1LogicalTransformTest : public Game
{
