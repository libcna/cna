...
// plan_dx2.md Phase O4 (DX2-30..DX2-35): the real proof DX6's (a port of DX30's own, itself a port of DX2's) CPU transform/clip -> D3DTLVERTEX
...
// to IGraphicsBackend::DrawPrimitivesEx() -- Dx6GraphicsBackend's own override, built on the same
...
// safe D3DCULL_NONE default (see Dx6GraphicsBackend.cpp's Create3DDevice), so this test's own
...
class Dx6ColoredPrimitivesTest : public Game
{
