...
// to IGraphicsRenderer::DrawPrimitivesEx() -- Dx6Renderer's own override, built on the same
...
// safe D3DCULL_NONE default (see Dx6Renderer.cpp's Create3DDevice), so this test's own
