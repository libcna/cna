...
class Dx8RemainingDefaultsTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        check(backend.CreateTexture3D(2, 2, 2, false, 0) == nullptr &&
              ...
              "CreateTexture3D/CreateTextureCube/CreateRenderTargetCube all return nullptr (DX8/DX8+ features)");
