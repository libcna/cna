...
// plan_opengl2.md: pixel-exact 3D vertex-format proof for the native OpenGL 2.1 graphics backend
...
// covered here -- this backend's 3D shaders are unlit (plan_opengl2.md's own documented
