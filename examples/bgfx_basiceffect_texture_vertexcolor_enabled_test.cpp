...
// and fixed the same way, on Bgfx: `vs_colored_textured3d.sc` previously computed
...
class BgfxBasicEffectTextureVertexColorEnabledTest : public Game
{
...
public:
    BgfxBasicEffectTextureVertexColorEnabledTest()
    {
...
int main()
{
    BgfxBasicEffectTextureVertexColorEnabledTest game;
    game.Run();
