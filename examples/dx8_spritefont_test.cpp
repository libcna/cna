...
// plan_dx2.md Phase O2 (DX2-13, 2D layer ported from DX1-50..DX1-54): SpriteFont / DrawString tests for the DX8 (real
...
// a color-match tolerance to work around that renderer's own physical/logical scaling), DX8's CPU
...
class Dx8SpriteFontTest : public Game
{
