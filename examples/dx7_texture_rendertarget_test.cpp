...
//   ...) round-trips through Dx7TextureRenderer::UpdatePixels (Lock()/memcpy/Unlock()) without
//   throwing (DX2-20/21).
...
class Dx7TextureRenderTargetTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // CNA_RENDERER_D3D9-only) -- an honest, documented gap for DX7 (and DX2/DX3, its own porting sources), not silently dropped.
        {
            bool threw = false;
...
int main()
{
    Dx7TextureRenderTargetTest game;
    game.Run();
