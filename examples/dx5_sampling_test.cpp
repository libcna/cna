...
// TextureAddressMode (Wrap/Mirror/Clamp) sampling tests for the DX5 (DirectDraw v4, via
...
// blend-formula concern (DX2-40..44, already covered by Dx5_Blend).
//
...
class Dx5SamplingTest : public Game
{
