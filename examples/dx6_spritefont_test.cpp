...
// plan_dx2.md Phase O2 (DX2-13, 2D layer ported from DX1-50..DX1-54): SpriteFont / DrawString tests for the DX6 (real
...
// a color-match tolerance to work around that renderer's own physical/logical scaling), DX6's CPU
...
class Dx6SpriteFontTest : public Game
{
