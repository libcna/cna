...
// plan_dx8.md Phase S6: real stencil buffer write-then-test through the full XNA public API
// (GraphicsDevice.DepthStencilState), proving stencil (unchanged from DX6, ported verbatim)
// survives DX8's removal of the whole viewport object and its texture-binding simplification.
...
class Dx8StencilTest : public Game
{
