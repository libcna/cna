...
// TextureAddressMode (Wrap/Mirror/Clamp) sampling tests for the DX8 (DirectDraw v4, via
...
// blend-formula concern (DX2-40..44, already covered by Dx8_Blend).
//
...
class Dx8SamplingTest : public Game
{
