...
// confirmed D3DFILL_WIREFRAME genuinely renders edge-only output here (see Dx3Renderer.hpp's
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        auto& renderer = static_cast<CNA::Internal::Renderers::Dx3::Dx3Renderer&>(dev.GetRenderer());
        ...
        check(!renderer.SupportsStencilBuffer(), "standalone stencil hook reports depth-only DX3 truthfully");
