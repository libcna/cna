...
//   ...) round-trips through Dx5TextureRenderer::UpdatePixels (Lock()/memcpy/Unlock()) without
//   throwing (DX2-20/21).
...
//   no artificial dimension cap (spike-confirmed up to 16384x16384), unlike DX3's free-direct
//   (DX2-28).
//
...
class Dx5TextureRenderTargetTest : public Game
{
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // Check H (DX2-28): real finding, spike-confirmed rather than assumed -- unlike DX3's
        ...
        // CNA_RENDERER_D3D9-only) -- an honest, documented gap for DX5 (and DX2/DX3, its own porting sources), not silently dropped.
        {
            bool threw = false;
...
int main()
{
    Dx5TextureRenderTargetTest game;
    game.Run();
