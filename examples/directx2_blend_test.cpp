...
// plan_dx2.md Phase O2 (DX2-12, 2D layer ported from DX1-40..DX1-44): blend-mode compositing math tests for the DIRECTX2
...
class DirectX2BlendTest : public Game
{
