...
// confirmed D3DFILL_WIREFRAME genuinely renders edge-only output here (see Dx2Renderer.hpp's
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        auto& renderer = static_cast<CNA::Internal::Renderers::Dx2::Dx2Renderer&>(dev.GetRenderer());
