...
// CNA::GraphicsCapability: verifies GraphicsDevice::SupportsCapability() correctly reports DX8's
// capability set. DX8's 3D pipeline is genuinely real end-to-end -- ThreeD and DepthStencilBuffer
...
protected:
    void Draw(const GameTime&) override
    {
        ...
        // DX2-DX7's own software rasterizer, AnisotropicFiltering also reports true -- DX8 runs
...
int main()
{
    Dx8GraphicsCapabilityTest game;
    game.Run();
