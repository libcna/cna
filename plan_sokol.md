...
### Phase 7 — Closing the EasyGL feature gap (SOKOL-33/37/38/39 landed)
...
| Environment-mapped, skinned or PBR 3D shading (`EnvironmentMapEffect`, skinned `BasicEffect`) | ✅ | ⬜ throws, naming the unsupported combination | `SOKOL-34`/`SOKOL-35` (PBR excepted -- no CNA backend has PBR yet, out of scope here). |
