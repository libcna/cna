...
**Status:** PARTIALLY FIXED. Twenty-three crash classes are fixed by
...
(`tools/graphics/compiled_effect_fuzzer.cpp --campaign`) found twenty-three distinct ways it crashed the
