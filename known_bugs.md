...
**Status:** PARTIALLY FIXED. Thirty-two crash classes are fixed by
...
(`tools/graphics/compiled_effect_fuzzer.cpp --campaign`) found thirty-two distinct ways it crashed the
