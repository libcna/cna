...
**Status:** PARTIALLY FIXED. Twenty-nine crash classes are fixed by
...
(`tools/graphics/compiled_effect_fuzzer.cpp --campaign`) found twenty-nine distinct ways it crashed the
