...
**Status:** PARTIALLY FIXED. Thirty-one crash classes are fixed by
...
(`tools/graphics/compiled_effect_fuzzer.cpp --campaign`) found thirty-one distinct ways it crashed the
