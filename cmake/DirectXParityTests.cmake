...
function(cna_register_d3d_parity_tests)
    ...
    cna_d3d_parity_fixture(
        ...
        DIRECTX11_TIMEOUT 300 DIRECTX12_TIMEOUT 600)
    cna_d3d_parity_fixture(
        NAME RenderTarget_MsaaDepthContract TARGET rendertarget_msaa_depth DIRECTX12_ORDER 2060
        SOURCE "${CNA_GRAPHICS_EXAMPLES_DIR}/rendertarget_msaa_depth_contract_test.cpp"
        DIRECTX11_TIMEOUT 900 DIRECTX12_TIMEOUT 900)
    cna_d3d_parity_fixture(
        NAME RenderTarget_MsaaFirstReadback TARGET rendertarget_msaa_first_readback DIRECTX12_ORDER 2070
    ...
    cna_d3d_parity_fixture(
        ...
        DIRECTX11_TIMEOUT 300 DIRECTX12_TIMEOUT 600)
    cna_d3d_parity_fixture(
        NAME DxtFormat TARGET dxt_format DIRECTX12_ORDER 1894
        SOURCE "${CMAKE_SOURCE_DIR}/modules/renderers/easygl/examples/easygl_dxt_format_test.cpp"
        DIRECTX11_TIMEOUT 300 DIRECTX12_TIMEOUT 600)
    cna_d3d_parity_fixture(
        NAME Dxt1_FromStream TARGET dxt1_fromstream DIRECTX12_ORDER 1896
    ...
    cna_d3d_parity_fixture(
        ...
        DIRECTX11_TIMEOUT 300 DIRECTX12_TIMEOUT 600)
    cna_d3d_parity_fixture(
        NAME ShaderEffect_ReflectionContract TARGET shader_effect_reflection DIRECTX12_ORDER 87
    ...
    cna_d3d_parity_fixture(
        ...
        DIRECTX11_TIMEOUT 600 DIRECTX12_TIMEOUT 900)
    cna_d3d_parity_fixture(
        NAME PresentationParameters TARGET presentation_parameters DIRECTX12_ORDER 2320
        SOURCE "${CMAKE_SOURCE_DIR}/modules/renderers/easygl/examples/easygl_presentation_parameters_test.cpp")
    cna_d3d_parity_fixture(
        NAME PresentationFormatContract TARGET presentation_format_contract DIRECTX12_ORDER 2330
    ...
    cna_d3d_parity_fixture(
        ...
        DIRECTX11_TIMEOUT 300 DIRECTX12_TIMEOUT 600)
    cna_d3d_parity_fixture(
        NAME RendererCapabilityTruth TARGET renderer_capability_truth DIRECTX12_ORDER 2350
