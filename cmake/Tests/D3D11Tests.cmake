if(CNA_BUILD_TESTS AND CNA_GRAPHICS_RENDERER STREQUAL "D3D11")
    enable_testing()
    ...
    cna_register_renderer_test(NAME D3D11_Smoke COMMAND ${_d3d11_smoke_cmd}
    ...
    cna_register_renderer_test(NAME D3D11_GraphicsDevice_DepthContract
    ...
    cna_register_renderer_test(NAME D3D11_Common COMMAND ${_d3d11_common_cmd}
    ...
    cna_register_renderer_test(NAME D3D11_BlendState_Opaque COMMAND ${_d3d11_blend_opaque_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_BlendState_AlphaBlend COMMAND ${_d3d11_blend_alpha_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_DepthStencilState_StencilEnable COMMAND ${_d3d11_ds_stencil_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_RasterizerState_CullMode COMMAND ${_d3d11_rast_cullmode_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_Pbr_VertexColor COMMAND ${_d3d11_pbr_vertexcolor_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_EnvironmentMapAmountZero COMMAND ${_d3d11_envmap_amount_zero_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_SkinnedEffect_WorldNormal COMMAND ${_d3d11_skinned_world_normal_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_SkinnedEffect_LightingConformance COMMAND ${_d3d11_skinned_lighting_conformance_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_ViewSpaceFog COMMAND ${_d3d11_viewspace_fog_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_AlphaTest_Fog COMMAND ${_d3d11_alphatest_fog_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_DualTextureEffect_Fog COMMAND ${_d3d11_dualtexture_fog_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_EnvironmentMapEffect_Fog COMMAND ${_d3d11_environmentmap_fog_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_SkinnedEffect_Fog COMMAND ${_d3d11_skinnedeffect_fog_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_SpriteBatch_CustomViewport COMMAND ${_d3d11_spritebatch_custom_viewport_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_Texture2D_GetDataContract
    ...
    # undersized one.
    cna_d3d11_test(cna_test_d3d11_texture2d_getdata_transfer_range examples/texture2d_getdata_transfer_range_test.cpp)
    cna_d3d11_ctest_command(_d3d11_texture2d_getdata_transfer_range_cmd cna_test_d3d11_texture2d_getdata_transfer_range)
    cna_register_renderer_test(NAME D3D11_Texture2D_GetDataTransferRange
        COMMAND ${_d3d11_texture2d_getdata_transfer_range_cmd}
        TIMEOUT 60 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_RenderTarget_SamplingOrientation
    ...
    cna_register_renderer_test(NAME D3D11_StockEffectSamplerContract
    ...
    cna_register_renderer_test(NAME D3D11_TextureFilterOrdinalContract
    ...
    cna_d3d11_test(cna_test_d3d11_envmap_cube_sampler
                   examples/envmap_cube_sampler_contract_test.cpp)
    cna_d3d11_ctest_command(_d3d11_envmap_cube_sampler_cmd cna_test_d3d11_envmap_cube_sampler)
    cna_register_renderer_test(NAME D3D11_EnvMapCubeSamplerContract
    ...
    cna_register_renderer_test(NAME D3D11_DualTextureSlotSamplerContract
    ...
    cna_d3d11_ctest_command(_d3d11_texture_filter_mip_cmd cna_test_d3d11_texture_filter_mip_contract)
    cna_register_renderer_test(NAME D3D11_TextureFilterMipContract
        COMMAND ${_d3d11_texture_filter_mip_cmd}
        TIMEOUT 300 LABELS "D3D11")
    ...
    cna_d3d11_test(cna_test_d3d11_descriptor_capacity
                   examples/descriptor_capacity_contract_test.cpp)
    cna_d3d11_ctest_command(_d3d11_descriptor_capacity_cmd cna_test_d3d11_descriptor_capacity)
    cna_register_renderer_test(NAME D3D11_DescriptorCapacityContract
        COMMAND ${_d3d11_descriptor_capacity_cmd}
        TIMEOUT 900 LABELS "D3D11")
    ...
    cna_register_renderer_test(NAME D3D11_PointSamplingContract
    ...
    cna_register_renderer_test(NAME D3D11_RenderTarget_ProducerConsumer
    ...
    cna_register_renderer_test(NAME D3D11_RenderTarget_EffectSource
    ...
    cna_register_renderer_test(NAME D3D11_CubeVolume_GetDataContract
    ...
    cna_register_renderer_test(NAME D3D11_RenderTargetCube_GetDataContract
    ...
    cna_register_renderer_test(NAME D3D11_RenderTargetCube_Usage
    ...
    cna_register_renderer_test(NAME D3D11_RenderTargetCube_MsaaFace
    ...
    cna_register_renderer_test(NAME D3D11_RenderTarget_DepthStencilUsage
    ...
    cna_register_renderer_test(NAME D3D11_RenderTarget_PassBoundary
    ...
    cna_register_renderer_test(NAME D3D11_GraphicsDevice_OrderedClear
    ...
    cna_register_renderer_test(NAME D3D11_Backbuffer_PassOrder
    ...
    cna_register_renderer_test(NAME D3D11_Deferred_Viewport
    ...
    cna_register_renderer_test(NAME D3D11_Deferred_Scissor
    ...
    cna_register_renderer_test(NAME D3D11_CubeVolume_SetDataContract
    ...
    cna_register_renderer_test(NAME D3D11_RenderTarget_FirstUse
