if(CNA_BUILD_TESTS AND NOT EMSCRIPTEN AND NOT WIN32
   AND CNA_GRAPHICS_BACKEND STREQUAL "SDL_RENDERER")
    ...
    cna_register_backend_test(NAME SDL_Renderer_Texture2D_GetDataContract COMMAND cna_test_sdl_texture2d_getdata_contract
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
    ...
    cna_register_backend_test(NAME SDL_Renderer_Texture2D_GetDataTransferRange COMMAND cna_test_sdl_texture2d_getdata_transfer_range
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
    ...
    cna_register_backend_test(NAME SDL_Renderer_CubeVolume_GetDataContract COMMAND cna_test_sdl_cube_volume_getdata_contract
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
    ...
    cna_register_backend_test(NAME SDL_Renderer_RenderTargetCube_GetDataContract COMMAND cna_test_sdl_rendertargetcube_getdata_contract
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
    ...
    cna_register_backend_test(NAME SDL_Renderer_RenderTargetCube_Usage COMMAND cna_test_sdl_rendertargetcube_usage
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
    ...
    cna_register_backend_test(NAME SDL_Renderer_RenderTargetCube_MsaaFace COMMAND cna_test_sdl_rendertargetcube_msaa_face
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
    ...
    cna_register_backend_test(NAME SDL_Renderer_RenderTarget_DepthStencilUsage COMMAND cna_test_sdl_rendertarget_depthstencil_usage
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
    ...
    cna_register_backend_test(NAME SDL_Renderer_RenderTarget_PassBoundary COMMAND cna_test_sdl_rendertarget_pass_boundary
    ...
    cna_register_backend_test(NAME SDL_Renderer_Backbuffer_PassOrder COMMAND cna_test_sdl_backbuffer_pass_order
    ...
    cna_register_backend_test(NAME SDL_Renderer_Unsupported3DBehavior
