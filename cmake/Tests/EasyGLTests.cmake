...
# Emscripten-only gate in BackendSelection.cmake.
if(CNA_BUILD_EXAMPLES AND CNA_BUILD_TESTS AND NOT EMSCRIPTEN AND NOT WIN32
   AND (CNA_GRAPHICS_BACKEND STREQUAL "OPENGLES" OR CNA_GRAPHICS_BACKEND STREQUAL "OPENGL33"))
        ...
        cna_register_backend_test(NAME EasyGL_GFX153_SourceRectangleOrientation
        ...
        cna_register_backend_test(NAME EasyGL_TextureFilterOrdinalContract
    ...
    # the shader's product is separable -- so independence is measured, not inferred.
        ...
        cna_register_backend_test(NAME EasyGL_DescriptorCapacityContract
    ...
    # run is what establishes that EASYGL already honoured the contract rather than being made to.
        ...
        cna_register_backend_test(NAME EasyGL_BackbufferFirstRead COMMAND cna_test_easygl_backbuffer_first_read
            TIMEOUT 300 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
        ...
        cna_register_backend_test(NAME EasyGL_BackbufferReject COMMAND cna_test_easygl_backbuffer_reject
            TIMEOUT 300 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
        ...
        cna_register_backend_test(NAME EasyGL_RenderTarget_FirstUse
        ...
        cna_register_backend_test(NAME EasyGL_SpriteBatch3DOrder
        ...
        cna_register_backend_test(NAME EasyGL_FrontFaceWinding
        ...
        cna_register_backend_test(NAME EasyGL_TriangleStripWinding
    ...
    # undersized one.
        ...
        cna_register_backend_test(NAME EasyGL_Texture2D_GetDataTransferRange COMMAND cna_test_easygl_texture2d_getdata_transfer_range
            TIMEOUT 60 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
        ...
        cna_register_backend_test(NAME EasyGL_CubeVolume_GetDataContract COMMAND cna_test_easygl_cube_volume_getdata_contract
            TIMEOUT 60 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
        ...
        cna_register_backend_test(NAME EasyGL_RenderTargetCube_GetDataContract COMMAND cna_test_easygl_rendertargetcube_getdata_contract
            TIMEOUT 60 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
        ...
        cna_register_backend_test(NAME EasyGL_RenderTarget_DepthStencilUsage COMMAND cna_test_easygl_rendertarget_depthstencil_usage
            TIMEOUT 60 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
        ...
        cna_register_backend_test(NAME EasyGL_RenderTarget_PassBoundary COMMAND cna_test_easygl_rendertarget_pass_boundary
            TIMEOUT 90 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")

        # REMED-GFX-129: cross-backend control for Vulkan's ordered-Clear correction. Clear() is an
        ...
        cna_register_backend_test(NAME EasyGL_GraphicsDevice_OrderedClear COMMAND cna_test_easygl_ordered_clear
            TIMEOUT 120 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
        ...
        cna_register_backend_test(NAME EasyGL_Backbuffer_PassOrder COMMAND cna_test_easygl_backbuffer_pass_order
            TIMEOUT 120 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
        ...
        cna_register_backend_test(NAME EasyGL_Deferred_Viewport COMMAND cna_test_easygl_deferred_viewport
            TIMEOUT 120 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
        ...
        cna_register_backend_test(NAME EasyGL_Deferred_Scissor COMMAND cna_test_easygl_deferred_scissor
            TIMEOUT 120 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
        ...
        cna_register_backend_test(NAME EasyGL_CubeVolume_SetDataContract COMMAND cna_test_easygl_cube_volume_setdata_contract
            TIMEOUT 60 ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}")
