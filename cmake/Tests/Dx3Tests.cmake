if(CNA_BUILD_TESTS AND CNA_GRAPHICS_RENDERER STREQUAL "DX3")
    enable_testing()
    ...
    # plan_dx3.md design decision 9: a real, automated proof this renderer never quietly reaches
    ...
    cna_register_renderer_test(NAME Dx3_Smoke COMMAND ${_dx30_smoke_cmd}
    ...
    cna_register_renderer_test(NAME Dx3_TextureRenderTarget COMMAND ${_dx30_texture_rendertarget_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_SpriteBatch COMMAND ${_dx30_spritebatch_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_Blend COMMAND ${_dx30_blend_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_AddressMode COMMAND ${_dx30_sampling_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_SpriteFont COMMAND ${_dx30_spritefont_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_GraphicsCapability COMMAND ${_dx30_graphics_capability_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_LogicalTransform COMMAND ${_dx30_logical_transform_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_Device3DSmoke COMMAND ${_dx30_device3d_smoke_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_VertexIndexBuffer COMMAND ${_dx30_vertex_index_buffer_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_ColoredPrimitives COMMAND ${_dx30_colored_primitives_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_IndexedPrimitives COMMAND ${_dx30_indexed_primitives_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_ZTest COMMAND ${_dx30_ztest_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_Texture3D COMMAND ${_dx30_texture3d_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_Clipping COMMAND ${_dx30_clipping_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_RemainingDefaults COMMAND ${_dx30_remaining_defaults_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_Lighting COMMAND ${_dx30_lighting_cmd}
        TIMEOUT 60 LABELS "DX3")
    ...
    cna_register_renderer_test(NAME Dx3_WireframeAniso COMMAND ${_dx30_wireframe_aniso_cmd}
        TIMEOUT 60 LABELS "DX3")
endif()
