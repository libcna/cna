...
# configure selected. Comparing HTML_DOM against CANVAS/EASYGL means configuring and building this
# target three times, once per backend (three separate build directories, e.g.
# cmake-build-canvas/cmake-build-easygl/cmake-build-htmldom) -- this file just makes sure the
...
if(CNA_BUILD_TESTS AND EMSCRIPTEN)
    ...
    if(CNA_GRAPHICS_BACKEND STREQUAL "EASYGL")
        # Emscripten defaults to -sMAX_WEBGL_VERSION=1; without this, EasyGL's ES 3.0/WebGL2
        ...
        # cna_house3d_demo target's own EASYGL/VULKAN Emscripten link options above.
        target_link_options(cna_bench_graphics_backend PRIVATE
