if(CNA_BUILD_TESTS AND CNA_GRAPHICS_RENDERER STREQUAL "DIRECTX12")
    ...
    # never constructs a window/swap chain (see examples/directx12_smoke_test.cpp's own header comment
    # for why), so this stays genuinely green on this Wine+vkd3d-proton dev loop.
    cna_directx12_test(cna_test_directx12_smoke examples/directx12_smoke_test.cpp)
    ...
    cna_directx12_test(cna_diag_d3d12_swapchain examples/directx12_swapchain_diag.cpp)
    ...
    cna_directx12_test(cna_test_directx12_texture2d_getdata_contract examples/texture2d_getdata_contract_test.cpp)
    ...
    # undersized one.
    cna_directx12_test(cna_test_directx12_texture2d_getdata_transfer_range examples/texture2d_getdata_transfer_range_test.cpp)
    ...
    cna_directx12_test(cna_test_directx12_texture_filter_ordinal examples/texture_filter_ordinal_contract_test.cpp)
    ...
    cna_directx12_test(cna_test_directx12_envmap_cube_sampler examples/envmap_cube_sampler_contract_test.cpp)
    ...
    cna_directx12_test(cna_test_directx12_dualtexture_slot_sampler examples/dualtexture_slot_sampler_contract_test.cpp)

    # REMED-GFX-175 cross-renderer control: the MIPMAP component of a TextureFilter ordinal.
    cna_directx12_test(cna_test_directx12_texture_filter_mip_contract examples/texture_filter_mip_contract_test.cpp)
    ...
    cna_directx12_test(cna_test_directx12_descriptor_capacity examples/descriptor_capacity_contract_test.cpp)
    ...
    cna_directx12_test(cna_test_directx12_descriptor_allocator examples/directx12_descriptor_allocator_test.cpp)
    if(CMAKE_CROSSCOMPILING)
    ...
    cna_directx12_test(cna_test_directx12_point_sampling examples/point_sampling_contract_test.cpp)
