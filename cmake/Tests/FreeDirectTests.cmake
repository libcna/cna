if(CNA_BUILD_TESTS AND NOT EMSCRIPTEN AND NOT WIN32
   AND CNA_GRAPHICS_BACKEND STREQUAL "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_Smoke COMMAND cna_test_freedirect_smoke
    ...
    cna_register_backend_test(NAME FreeDirect_TextureRenderTarget COMMAND cna_test_freedirect_texture_rendertarget
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_SpriteBatch COMMAND cna_test_freedirect_spritebatch
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_Blend COMMAND cna_test_freedirect_blend
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_AddressMode COMMAND cna_test_freedirect_sampling
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_SpriteFont COMMAND cna_test_freedirect_spritefont
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_No3D COMMAND cna_test_freedirect_no3d
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_LogicalTransform COMMAND cna_test_freedirect_logical_transform
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_Texture2D_GetDataContract COMMAND cna_test_freedirect_texture2d_getdata_contract
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_Texture2D_GetDataTransferRange COMMAND cna_test_freedirect_texture2d_getdata_transfer_range
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_CubeVolume_GetDataContract COMMAND cna_test_freedirect_cube_volume_getdata_contract
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_RenderTargetCube_GetDataContract COMMAND cna_test_freedirect_rendertargetcube_getdata_contract
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_RenderTargetCube_Usage COMMAND cna_test_freedirect_rendertargetcube_usage
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_RenderTargetCube_MsaaFace COMMAND cna_test_freedirect_rendertargetcube_msaa_face
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_RenderTarget_DepthStencilUsage COMMAND cna_test_freedirect_rendertarget_depthstencil_usage
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
    ...
    cna_register_backend_test(NAME FreeDirect_RenderTarget_PassBoundary COMMAND cna_test_freedirect_rendertarget_pass_boundary
    ...
    cna_register_backend_test(NAME FreeDirect_Backbuffer_PassOrder COMMAND cna_test_freedirect_backbuffer_pass_order
    ...
    cna_register_backend_test(NAME FreeDirect_CubeVolume_SetDataContract COMMAND cna_test_freedirect_cube_volume_setdata_contract
        TIMEOUT 30 ENVIRONMENT "SDL_VIDEODRIVER=dummy" LABELS "FREEDIRECT")
endif()
