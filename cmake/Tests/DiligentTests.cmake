if(CNA_BUILD_TESTS AND NOT EMSCRIPTEN AND CNA_GRAPHICS_BACKEND STREQUAL "DILIGENT")
    ...
    cna_register_backend_test(NAME Diligent_SpriteFont COMMAND cna_test_diligent_spritefont
        TIMEOUT 90 LABELS "GraphicsSmoke;Diligent"
        ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}"
        SKIP_REGULAR_EXPRESSION "\\[SKIP\\] CNA Diligent smoke")
    ...
    cna_register_backend_test(NAME Diligent_Model COMMAND cna_test_diligent_model
        TIMEOUT 90 LABELS "GraphicsSmoke;Diligent"
        ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}"
        SKIP_REGULAR_EXPRESSION "\\[SKIP\\] CNA Diligent smoke")
    ...
    cna_register_backend_test(NAME Diligent_Mip COMMAND cna_test_diligent_mip
        TIMEOUT 90 LABELS "GraphicsSmoke;Diligent"
        ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}"
        SKIP_REGULAR_EXPRESSION "\\[SKIP\\] CNA Diligent smoke")
    ...
    cna_register_backend_test(NAME Diligent_Npot COMMAND cna_test_diligent_npot
        TIMEOUT 90 LABELS "GraphicsSmoke;Diligent"
        ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}"
        SKIP_REGULAR_EXPRESSION "\\[SKIP\\] CNA Diligent smoke")
    ...
    cna_register_backend_test(NAME Diligent_RenderTargetMipGen
        COMMAND cna_test_diligent_rendertarget_mipgen
        TIMEOUT 90 LABELS "GraphicsSmoke;Diligent"
        ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}"
        SKIP_REGULAR_EXPRESSION "\\[SKIP\\] CNA Diligent smoke")
    ...
    cna_register_backend_test(NAME Diligent_ScissorPipelineCache
        COMMAND cna_test_diligent_scissor_pipelinecache
        TIMEOUT 90 LABELS "GraphicsSmoke;Diligent"
        ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}"
        SKIP_REGULAR_EXPRESSION "\\[SKIP\\] CNA Diligent smoke")
    ...
    cna_register_backend_test(NAME Diligent_InstancedStride
        COMMAND cna_test_diligent_instanced_stride
        TIMEOUT 90 LABELS "GraphicsSmoke;Diligent"
        ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}"
        SKIP_REGULAR_EXPRESSION "\\[SKIP\\] CNA Diligent smoke")
    ...
    cna_register_backend_test(NAME Diligent_CapabilityConsistency
        COMMAND cna_test_diligent_capability_consistency
        TIMEOUT 90 LABELS "GraphicsSmoke;Diligent"
        ENVIRONMENT "SDL_VIDEODRIVER=x11;DISPLAY=${CNA_TEST_DISPLAY}"
        SKIP_REGULAR_EXPRESSION "\\[SKIP\\] CNA Diligent smoke")
