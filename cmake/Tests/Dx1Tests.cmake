if(CNA_BUILD_TESTS AND CNA_GRAPHICS_RENDERER STREQUAL "DX1")
    enable_testing()
    ...
    cna_register_renderer_test(NAME Dx1_Smoke COMMAND ${_dx1_smoke_cmd}
    ...
    cna_register_renderer_test(NAME Dx1_TextureRenderTarget COMMAND ${_dx1_texture_rendertarget_cmd}
        TIMEOUT 60 LABELS "DX1")
    ...
    cna_register_renderer_test(NAME Dx1_SpriteBatch COMMAND ${_dx1_spritebatch_cmd}
        TIMEOUT 60 LABELS "DX1")
    ...
    cna_register_renderer_test(NAME Dx1_Blend COMMAND ${_dx1_blend_cmd}
        TIMEOUT 60 LABELS "DX1")
    ...
    cna_register_renderer_test(NAME Dx1_AddressMode COMMAND ${_dx1_sampling_cmd}
        TIMEOUT 60 LABELS "DX1")
    ...
    cna_register_renderer_test(NAME Dx1_SpriteFont COMMAND ${_dx1_spritefont_cmd}
        TIMEOUT 60 LABELS "DX1")
    ...
    cna_register_renderer_test(NAME Dx1_No3D COMMAND ${_dx1_no3d_cmd}
        TIMEOUT 60 LABELS "DX1")
    ...
    cna_register_renderer_test(NAME Dx1_GraphicsCapability COMMAND ${_dx1_graphics_capability_cmd}
        TIMEOUT 60 LABELS "DX1")
    ...
    cna_register_renderer_test(NAME Dx1_LogicalTransform COMMAND ${_dx1_logical_transform_cmd}
        TIMEOUT 60 LABELS "DX1")
endif()
