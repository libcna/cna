if(CNA_BUILD_TESTS AND CNA_GRAPHICS_BACKEND STREQUAL "DX7")
    enable_testing()
    ...
    # plan_dx7.md design decision 16: a real, automated proof this backend never quietly reaches
    ...
    cna_register_backend_test(NAME Dx7_Smoke COMMAND ${_dx7_smoke_cmd}
    ...
    cna_register_backend_test(NAME Dx7_TextureRenderTarget COMMAND ${_dx7_texture_rendertarget_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_SpriteBatch COMMAND ${_dx7_spritebatch_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_Blend COMMAND ${_dx7_blend_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_AddressMode COMMAND ${_dx7_sampling_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_SpriteFont COMMAND ${_dx7_spritefont_cmd}
        TIMEOUT 60 LABELS "DX7")

    # CNA::GraphicsCapability: DX7 is fully 3D-capable from day one (a port of DX30's own, itself a port of DX2's
    ...
    cna_register_backend_test(NAME Dx7_GraphicsCapability COMMAND ${_dx7_graphics_capability_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_LogicalTransform COMMAND ${_dx7_logical_transform_cmd}
        TIMEOUT 60 LABELS "DX7")

    # NOTE: Dx1_No3D has no DX7 equivalent here either, same reasoning as DX2/DX30 -- DX7's
    ...
    cna_register_backend_test(NAME Dx7_Device3DSmoke COMMAND ${_dx7_device3d_smoke_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_VertexIndexBuffer COMMAND ${_dx7_vertex_index_buffer_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_ColoredPrimitives COMMAND ${_dx7_colored_primitives_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_IndexedPrimitives COMMAND ${_dx7_indexed_primitives_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_ZTest COMMAND ${_dx7_ztest_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_Texture3D COMMAND ${_dx7_texture3d_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_Clipping COMMAND ${_dx7_clipping_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_RemainingDefaults COMMAND ${_dx7_remaining_defaults_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_Lighting COMMAND ${_dx7_lighting_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_WireframeAniso COMMAND ${_dx7_wireframe_aniso_cmd}
        TIMEOUT 60 LABELS "DX7")
    ...
    cna_register_backend_test(NAME Dx7_Stencil COMMAND ${_dx7_stencil_cmd}
        TIMEOUT 60 LABELS "DX7")
endif()
