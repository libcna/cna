if(CNA_BUILD_TESTS AND CNA_GRAPHICS_RENDERER STREQUAL "DX8")
    enable_testing()
    ...
    # plan_dx8.md design decision 16: a real, automated proof this renderer never quietly reaches
    ...
    cna_register_renderer_test(NAME Dx8_Smoke COMMAND ${_dx8_smoke_cmd}
    ...
    cna_register_renderer_test(NAME Dx8_TextureRenderTarget COMMAND ${_dx8_texture_rendertarget_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_SpriteBatch COMMAND ${_dx8_spritebatch_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_Blend COMMAND ${_dx8_blend_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_AddressMode COMMAND ${_dx8_sampling_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_SpriteFont COMMAND ${_dx8_spritefont_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_GraphicsCapability COMMAND ${_dx8_graphics_capability_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_LogicalTransform COMMAND ${_dx8_logical_transform_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_Device3DSmoke COMMAND ${_dx8_device3d_smoke_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_VertexIndexBuffer COMMAND ${_dx8_vertex_index_buffer_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_ColoredPrimitives COMMAND ${_dx8_colored_primitives_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_IndexedPrimitives COMMAND ${_dx8_indexed_primitives_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_ZTest COMMAND ${_dx8_ztest_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_Texture3D COMMAND ${_dx8_texture3d_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_Clipping COMMAND ${_dx8_clipping_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_RemainingDefaults COMMAND ${_dx8_remaining_defaults_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_Lighting COMMAND ${_dx8_lighting_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_WireframeAniso COMMAND ${_dx8_wireframe_aniso_cmd}
        TIMEOUT 60 LABELS "DX8")
    ...
    cna_register_renderer_test(NAME Dx8_Stencil COMMAND ${_dx8_stencil_cmd}
        TIMEOUT 60 LABELS "DX8")
endif()
