if(CNA_BUILD_TESTS AND CNA_GRAPHICS_BACKEND STREQUAL "D3D10")
    enable_testing()
    ...
    # backend), mirroring DX7/DX8's own established discipline scripts.
    ...
    cna_register_backend_test(NAME D3D10_Smoke COMMAND ${_d3d10_smoke_cmd}
    ...
    cna_register_backend_test(NAME D3D10_Device3DSmoke COMMAND ${_d3d10_device3d_cmd}
        TIMEOUT 60 LABELS "D3D10")
    ...
    cna_register_backend_test(NAME D3D10_SpriteBatch COMMAND ${_d3d10_spritebatch_cmd}
        TIMEOUT 60 LABELS "D3D10")
    ...
    cna_register_backend_test(NAME D3D10_GraphicsCapability COMMAND ${_d3d10_cap_cmd}
        TIMEOUT 60 LABELS "D3D10")
    ...
    # DirectDraw-family backend's own equivalent check.
    cna_d3d10_test(cna_test_d3d10_mrt examples/d3d10_mrt_test.cpp)
    cna_d3d10_ctest_command(_d3d10_mrt_cmd cna_test_d3d10_mrt)
    cna_register_backend_test(NAME D3D10_MultipleRenderTargets COMMAND ${_d3d10_mrt_cmd}
        TIMEOUT 60 LABELS "D3D10")

    # State-object pixel-behaviour tests, reusing the same backend-agnostic EasyGL-authored
    ...
    cna_register_backend_test(NAME D3D10_BlendState_Opaque COMMAND ${_d3d10_blend_opaque_cmd}
        TIMEOUT 60 LABELS "D3D10")
    ...
    cna_register_backend_test(NAME D3D10_BlendState_AlphaBlend COMMAND ${_d3d10_blend_alpha_cmd}
        TIMEOUT 60 LABELS "D3D10")
    ...
    cna_register_backend_test(NAME D3D10_DepthStencilState_StencilEnable COMMAND ${_d3d10_ds_stencil_cmd}
        TIMEOUT 60 LABELS "D3D10")
    ...
    cna_register_backend_test(NAME D3D10_RasterizerState_CullMode COMMAND ${_d3d10_rast_cullmode_cmd}
        TIMEOUT 60 LABELS "D3D10")
endif()
