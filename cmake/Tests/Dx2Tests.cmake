if(CNA_BUILD_TESTS AND CNA_GRAPHICS_BACKEND STREQUAL "DX2")
    enable_testing()
    ...
    # plan_dx2.md design decision 12: a real, automated proof this backend never quietly reaches
    ...
    cna_register_backend_test(NAME Dx2_Smoke COMMAND ${_dx2_smoke_cmd}
    ...
    cna_register_backend_test(NAME Dx2_TextureRenderTarget COMMAND ${_dx2_texture_rendertarget_cmd}
        TIMEOUT 60 LABELS "DX2")
    ...
    cna_register_backend_test(NAME Dx2_SpriteBatch COMMAND ${_dx2_spritebatch_cmd}
        TIMEOUT 60 LABELS "DX2")
    ...
    cna_register_backend_test(NAME Dx2_Blend COMMAND ${_dx2_blend_cmd}
        TIMEOUT 60 LABELS "DX2")
    ...
    cna_register_backend_test(NAME Dx2_AddressMode COMMAND ${_dx2_sampling_cmd}
        TIMEOUT 60 LABELS "DX2")
    ...
    cna_register_backend_test(NAME Dx2_SpriteFont COMMAND ${_dx2_spritefont_cmd}
        TIMEOUT 60 LABELS "DX2")
    ...
    cna_register_backend_test(NAME Dx2_GraphicsCapability COMMAND ${_dx2_graphics_capability_cmd}
        TIMEOUT 60 LABELS "DX2")
    ...
    cna_register_backend_test(NAME Dx2_LogicalTransform COMMAND ${_dx2_logical_transform_cmd}
        TIMEOUT 60 LABELS "DX2")
