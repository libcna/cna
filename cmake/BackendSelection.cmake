...
option(CNA_BACKEND_DIRECT2D "Enable Direct2D 1.1 graphics backend (Windows only, 2D-only)" OFF)
...
option(CNA_BACKEND_GLIDE "Enable Glide 3.x graphics backend (Windows, external glide3x.dll at runtime)" OFF)
option(CNA_BACKEND_GDI "Enable classic Win32 GDI (2D-only) graphics backend" OFF)


# plan_llgl.md: LLGL (Low Level Graphics Library) -- unlike every other entry here, this backend
...
option(CNA_BACKEND_LLGL "Enable LLGL graphics backend" OFF)

# Metal owns the renderer directly; SDL provides only the native macOS window and CAMetalLayer.
option(CNA_BACKEND_METAL "Enable native Apple Metal graphics backend (macOS only)" OFF)

set(_cna_explicit_backend_selection OFF)
if(CNA_BACKEND_SDL_RENDERER OR CNA_BACKEND_OPENGLES OR CNA_BACKEND_OPENGL33 OR CNA_BACKEND_WEBGL1 OR CNA_BACKEND_WEBGL2 OR CNA_BACKEND_BGFX OR CNA_BACKEND_VULKAN OR CNA_BACKEND_WEBGPU OR CNA_BACKEND_MAGNUM OR CNA_BACKEND_HEADLESS OR CNA_BACKEND_SOFTWARE OR CNA_BACKEND_STUB OR CNA_BACKEND_D3D11 OR CNA_BACKEND_D3D12 OR CNA_BACKEND_DIRECT2D OR CNA_BACKEND_CANVAS OR CNA_BACKEND_HTML_DOM OR CNA_BACKEND_SKIA OR CNA_BACKEND_ASCII OR CNA_BACKEND_FREEDIRECT OR CNA_BACKEND_D3D9 OR CNA_BACKEND_DX1 OR CNA_BACKEND_DX2 OR CNA_BACKEND_DX3 OR CNA_BACKEND_DX5 OR CNA_BACKEND_DX6 OR CNA_BACKEND_DX7 OR CNA_BACKEND_DX8 OR CNA_BACKEND_D3D10 OR CNA_BACKEND_OPENGLES1 OR CNA_BACKEND_OPENGL4 OR CNA_BACKEND_OPENGL1 OR CNA_BACKEND_OPENGL2 OR CNA_BACKEND_SDL_GPU OR CNA_BACKEND_WICKED OR CNA_BACKEND_SOKOL OR CNA_BACKEND_DILIGENT OR CNA_BACKEND_GLIDE OR CNA_BACKEND_GDI OR CNA_BACKEND_LLGL OR CNA_BACKEND_METAL)
...
if(_cna_explicit_backend_selection)
    ...
    if(CNA_BACKEND_DIRECT2D)
        list(APPEND _cna_enabled_backends "DIRECT2D")
    endif()
    ...
    if(CNA_BACKEND_GLIDE)
        list(APPEND _cna_enabled_backends "GLIDE")
    endif()
    if(CNA_BACKEND_GDI)
        list(APPEND _cna_enabled_backends "GDI")
    endif()
    if(CNA_BACKEND_LLGL)
        list(APPEND _cna_enabled_backends "LLGL")
    endif()
    if(CNA_BACKEND_METAL)
        list(APPEND _cna_enabled_backends "METAL")
    endif()
...
if((CNA_GRAPHICS_BACKEND STREQUAL "D3D11" OR CNA_GRAPHICS_BACKEND STREQUAL "D3D12" OR CNA_GRAPHICS_BACKEND STREQUAL "D3D9" OR CNA_GRAPHICS_BACKEND STREQUAL "DIRECT2D" OR CNA_GRAPHICS_BACKEND STREQUAL "DX1" OR CNA_GRAPHICS_BACKEND STREQUAL "DX2" OR CNA_GRAPHICS_BACKEND STREQUAL "DX3" OR CNA_GRAPHICS_BACKEND STREQUAL "DX5" OR CNA_GRAPHICS_BACKEND STREQUAL "DX6" OR CNA_GRAPHICS_BACKEND STREQUAL "DX7" OR CNA_GRAPHICS_BACKEND STREQUAL "DX8" OR CNA_GRAPHICS_BACKEND STREQUAL "D3D10" OR CNA_GRAPHICS_BACKEND STREQUAL "GLIDE" OR CNA_GRAPHICS_BACKEND STREQUAL "GDI")
...
if(CNA_GRAPHICS_BACKEND STREQUAL "GLIDE" AND NOT CMAKE_SIZEOF_VOID_P EQUAL 4)
    message(FATAL_ERROR
...
if(CNA_GRAPHICS_BACKEND STREQUAL "METAL" AND NOT CMAKE_SYSTEM_NAME STREQUAL "Darwin")
    message(FATAL_ERROR
        "CNA: METAL backend is currently supported only on macOS; iOS and tvOS remain unvalidated.")
endif()
...
if(CNA_GRAPHICS_BACKEND STREQUAL "SDL_RENDERER")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/SdlRenderer")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "OPENGL1")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/OpenGL1")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "OPENGLES" OR CNA_GRAPHICS_BACKEND STREQUAL "OPENGL33"
    ...
    set(BACKEND_DIR "src/Graphics/Backends/EasyGL")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "BGFX")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Bgfx")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "VULKAN")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Vulkan")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "WEBGPU")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/WebGPU")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "MAGNUM")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Magnum")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "HEADLESS")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Headless")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "SOFTWARE")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Software")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "STUB")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Stub")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "D3D11")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/D3D11")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "D3D12")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/D3D12")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DIRECT2D")
    message(STATUS "CNA: Using DIRECT2D graphics backend (Windows-only, 2D-only)")
    set(BACKEND_DIR "src/Graphics/Backends/Direct2D")
    set(BACKEND_TARGET "cna_backend_graphics_direct2d")
    add_compile_definitions(CNA_BACKEND_DIRECT2D)
    set(CNA_BACKEND_DEFINE "CNA_BACKEND_DIRECT2D")
elseif(CNA_GRAPHICS_BACKEND STREQUAL "CANVAS")
    message(STATUS "CNA: Using CANVAS (HTML Canvas 2D) graphics backend")
    set(BACKEND_DIR "src/Graphics/Backends/Canvas")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "HTML_DOM")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/HtmlDom")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "SKIA")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Skia")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "ASCII")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Ascii")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "FREEDIRECT")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/FreeDirect")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "D3D9")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/D3D9")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX1")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Dx1")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX2")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Dx2")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX3")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Dx3")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX5")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Dx5")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX6")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Dx6")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX7")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Dx7")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX8")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Dx8")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "D3D10")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/D3D10")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DILIGENT")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Diligent")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "METAL")
    ...
    message(STATUS "CNA: Using native METAL graphics backend")
    set(BACKEND_DIR "src/Graphics/Backends/Metal")
    set(BACKEND_TARGET "cna_backend_graphics_metal")
    add_compile_definitions(CNA_BACKEND_METAL)
    set(CNA_BACKEND_DEFINE "CNA_BACKEND_METAL")
elseif(CNA_GRAPHICS_BACKEND STREQUAL "SDL_GPU")
    message(STATUS "CNA: Using SDL_GPU graphics backend")
    set(BACKEND_DIR "src/Graphics/Backends/SdlGpu")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "OPENGLES1")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/OpenGLES1")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "OPENGL4")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/OpenGL4")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "OPENGL2")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/OpenGL2")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "WICKED")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Wicked")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "SOKOL")
    ...
    set(BACKEND_DIR "src/Graphics/Backends/Sokol")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "GLIDE")
    message(STATUS "CNA: Using GLIDE 3.x graphics backend (runtime glide3x.dll required)")
    set(BACKEND_DIR "src/Graphics/Backends/Glide")
    set(BACKEND_TARGET "cna_backend_graphics_glide")
    add_compile_definitions(CNA_BACKEND_GLIDE)
    set(CNA_BACKEND_DEFINE "CNA_BACKEND_GLIDE")
elseif(CNA_GRAPHICS_BACKEND STREQUAL "GDI")
    message(STATUS "CNA: Using classic Win32 GDI 2D graphics backend")
    set(BACKEND_DIR "src/Graphics/Backends/Gdi")
    set(BACKEND_TARGET "cna_backend_graphics_gdi")
    add_compile_definitions(CNA_BACKEND_GDI)
    set(CNA_BACKEND_DEFINE "CNA_BACKEND_GDI")
elseif(CNA_GRAPHICS_BACKEND STREQUAL "LLGL")
    message(STATUS "CNA: Using LLGL graphics backend")
    set(BACKEND_DIR "src/Graphics/Backends/Llgl")
    set(BACKEND_TARGET "cna_backend_graphics_llgl")
    add_compile_definitions(CNA_BACKEND_LLGL)
    set(CNA_BACKEND_DEFINE "CNA_BACKEND_LLGL")
