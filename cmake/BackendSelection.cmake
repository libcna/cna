...
if(CNA_GRAPHICS_BACKEND STREQUAL "SDL_RENDERER")
    ...
    set(BACKEND_DIR "modules/renderers/sdl-renderer")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "OPENGL1")
    ...
    set(BACKEND_DIR "modules/renderers/opengl1")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "OPENGLES" OR CNA_GRAPHICS_BACKEND STREQUAL "OPENGL33"
    ...
    set(BACKEND_DIR "modules/renderers/easygl")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "BGFX")
    ...
    set(BACKEND_DIR "modules/renderers/bgfx")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "VULKAN")
    ...
    set(BACKEND_DIR "modules/renderers/vulkan")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "WEBGPU")
    ...
    set(BACKEND_DIR "modules/renderers/webgpu")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "MAGNUM")
    ...
    set(BACKEND_DIR "modules/renderers/magnum")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "HEADLESS")
    ...
    set(BACKEND_DIR "modules/renderers/headless")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "SOFTWARE")
    ...
    set(BACKEND_DIR "modules/renderers/software")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "STUB")
    ...
    set(BACKEND_DIR "modules/renderers/stub")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "D3D11")
    ...
    set(BACKEND_DIR "modules/renderers/d3d11")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "D3D12")
    ...
    set(BACKEND_DIR "modules/renderers/d3d12")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DIRECT2D")
    ...
    set(BACKEND_DIR "modules/renderers/direct2d")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "CANVAS")
    ...
    set(BACKEND_DIR "modules/renderers/canvas")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "HTML_DOM")
    ...
    set(BACKEND_DIR "modules/renderers/html-dom")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "SKIA")
    ...
    set(BACKEND_DIR "modules/renderers/skia")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "ASCII")
    ...
    set(BACKEND_DIR "modules/renderers/ascii")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "FREEDIRECT")
    ...
    set(BACKEND_DIR "modules/renderers/freedirect")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "D3D9")
    ...
    set(BACKEND_DIR "modules/renderers/d3d9")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX1")
    ...
    set(BACKEND_DIR "modules/renderers/dx1")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX2")
    ...
    set(BACKEND_DIR "modules/renderers/dx2")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX3")
    ...
    set(BACKEND_DIR "modules/renderers/dx3")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX5")
    ...
    set(BACKEND_DIR "modules/renderers/dx5")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX6")
    ...
    set(BACKEND_DIR "modules/renderers/dx6")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX7")
    ...
    set(BACKEND_DIR "modules/renderers/dx7")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DX8")
    ...
    set(BACKEND_DIR "modules/renderers/dx8")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "D3D10")
    ...
    set(BACKEND_DIR "modules/renderers/d3d10")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "DILIGENT")
    ...
    set(BACKEND_DIR "modules/renderers/diligent")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "METAL")
    ...
    set(BACKEND_DIR "modules/renderers/metal")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "SDL_GPU")
    ...
    set(BACKEND_DIR "modules/renderers/sdl-gpu")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "OPENGLES1")
    ...
    set(BACKEND_DIR "modules/renderers/opengles1")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "OPENGL4")
    ...
    set(BACKEND_DIR "modules/renderers/opengl4")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "OPENGL2")
    ...
    set(BACKEND_DIR "modules/renderers/opengl2")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "WICKED")
    ...
    set(BACKEND_DIR "modules/renderers/wicked")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "SOKOL")
    ...
    set(BACKEND_DIR "modules/renderers/sokol")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "GLIDE")
    ...
    set(BACKEND_DIR "modules/renderers/glide")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "GDI")
    ...
    set(BACKEND_DIR "modules/renderers/gdi")
...
elseif(CNA_GRAPHICS_BACKEND STREQUAL "LLGL")
    ...
    set(BACKEND_DIR "modules/renderers/llgl")
