...
if(_cna_explicit_renderer_selection)
    ...
    if(CNA_RENDERER_RLGL)
        list(APPEND _cna_enabled_renderers "RLGL")
    endif()
...
if(CNA_GRAPHICS_RENDERER STREQUAL "RLGL" AND NOT (CMAKE_SYSTEM_NAME STREQUAL "Linux" OR CMAKE_SYSTEM_NAME STREQUAL "Windows" OR CMAKE_SYSTEM_NAME STREQUAL "Darwin"))
    message(FATAL_ERROR
        "CNA: RLGL initially supports desktop Linux, Windows and macOS only; its selected "
        "standalone rlgl profile requires an OpenGL 3.3 core context.")
endif()
...
elseif(CNA_GRAPHICS_RENDERER STREQUAL "RLGL")
    message(STATUS "CNA: Using RLGL (standalone rlgl 6.0, OpenGL 3.3 core) graphics renderer")
    set(RENDERER_DIR "modules/renderers/rlgl")
    set(RENDERER_TARGET "cna_renderer_rlgl")
    list(APPEND _cna_identity_defines CNA_RENDERER_RLGL)
