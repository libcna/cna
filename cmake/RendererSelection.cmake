...
set(CNA_GRAPHICS_RENDERER "${_cna_default_renderer}" CACHE STRING "Graphics renderer to use (SDL_RENDERER, OPENGLES3, OPENGL33, WEBGL1, WEBGL2, BGFX, VULKAN, WEBGPU, MAGNUM, HEADLESS, SOFTWARE, STUB, DIRECTX11, DIRECTX12, DIRECT2D, CANVAS, HTML_DOM, SKIA, BLEND2D, ASCII, FREEDIRECT, DIRECTX9, DIRECTX1, DIRECTX2, DIRECTX3, DIRECTX5, DIRECTX6, DIRECTX7, DIRECTX8, DIRECTX10, OPENGLES1, OPENGL4, OPENGL1, OPENGL2, SDL_GPU, WICKED, SOKOL, DILIGENT, GLIDE, GDI, LLGL, or METAL)")
set_property(CACHE CNA_GRAPHICS_RENDERER PROPERTY STRINGS "SDL_RENDERER" "OPENGLES3" "OPENGL33" "WEBGL1" "WEBGL2" "BGFX" "VULKAN" "WEBGPU" "MAGNUM" "HEADLESS" "SOFTWARE" "STUB" "DIRECTX11" "DIRECTX12" "DIRECT2D" "CANVAS" "HTML_DOM" "SKIA" "BLEND2D" "ASCII" "FREEDIRECT" "DIRECTX9" "DIRECTX1" "DIRECTX2" "DIRECTX3" "DIRECTX5" "DIRECTX6" "DIRECTX7" "DIRECTX8" "DIRECTX10" "OPENGLES1" "OPENGL4" "OPENGL1" "OPENGL2" "SDL_GPU" "WICKED" "SOKOL" "DILIGENT" "GLIDE" "GDI" "LLGL" "METAL")
...
# plan_ascii.md: SDL-windowed retro text/glyph-grid renderer -- a thin decorator around
...
if(_cna_explicit_renderer_selection)
    ...
    if(CNA_RENDERER_ASCII)
        list(APPEND _cna_enabled_renderers "ASCII")
    endif()
...
elseif(CNA_GRAPHICS_RENDERER STREQUAL "ASCII")
    message(STATUS "CNA: Using ASCII (SDL-windowed glyph-grid) graphics renderer")
    set(RENDERER_DIR "modules/renderers/ascii")
    set(RENDERER_TARGET "cna_renderer_ascii")
