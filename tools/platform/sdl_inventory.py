...
MODULE_CONCERNS = {
    ...
    "graphics": "`GraphicsDevice`, common renderer contracts",
    "audio": "audio device/stream, mixer, microphone",
    "runtime": "`Game` loop, `GameWindow`, `GraphicsDeviceManager`",
    "media": "remaining test/backend configuration after PLAT-112",
    "core": "`Logger`, `Entrypoint` (`SDL_main`), `GraphicsRendererType`",
    "content": "remaining test prose/configuration after PLAT-111",
