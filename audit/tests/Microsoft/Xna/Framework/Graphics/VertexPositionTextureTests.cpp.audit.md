# Audit: tests/Microsoft/Xna/Framework/Graphics/VertexPositionTextureTests.cpp

## Metadata
- Source file: `tests/Microsoft/Xna/Framework/Graphics/VertexPositionTextureTests.cpp` (133 lines)
- Audit status: AUDITED (full read)
- Subsystem: `tests-xna-graphics` shard
- File type: C++ test file (Google Test)
- XNA/FNA relevance: Tests for `VertexPositionTexture.hpp`
- Main related tests: N/A (this IS a test file)

## Purpose
Exercises defaults, parameterized construction, equality, the 2-element `VertexDeclaration` layout
(Position/TextureCoordinate), `Equals`, `GetHashCode`, and `ToString()`.
...
divergence (32 actual vs. 20 XNA-documented).
...
now confirmed across every `VertexPosition*` type test file examined in this batch
(`VertexPositionColor` itself per Item 9, plus `VertexPositionColorTexture`,
