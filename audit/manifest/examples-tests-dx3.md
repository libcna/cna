# Manifest shard: `examples-tests-dx3`

[<- Back to AUDIT_MANIFEST.md](../AUDIT_MANIFEST.md)

Files in this shard: **9**
...
| 7 | `examples/dx3_spritebatch_test.cpp` | PENDING | [dx3_spritebatch_test.cpp.audit.md](../examples/dx3_spritebatch_test.cpp.audit.md) |
| 8 | `examples/dx3_spritefont_test.cpp` | PENDING | [dx3_spritefont_test.cpp.audit.md](../examples/dx3_spritefont_test.cpp.audit.md) |
| 9 | `examples/dx3_texture_rendertarget_test.cpp` | PENDING | [dx3_texture_rendertarget_test.cpp.audit.md](../examples/dx3_texture_rendertarget_test.cpp.audit.md) |
