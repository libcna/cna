# Audit: src/Microsoft/Devices/Sensors/CalibrationEventArgs.cpp

## Metadata
- Source file: `src/Microsoft/Devices/Sensors/CalibrationEventArgs.cpp` (13 lines)
...
## Purpose
Implements the defaulted constructor and `GetTypeName()`.
