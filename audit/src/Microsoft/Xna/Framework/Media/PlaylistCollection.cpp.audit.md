# Audit: src/Microsoft/Xna/Framework/Media/PlaylistCollection.cpp

## Metadata
- Source file: `src/Microsoft/Xna/Framework/Media/PlaylistCollection.cpp`
...
## Purpose
Pure delegation to `CNA::Internal::Media::MediaCollectionBase<Playlist>`.
