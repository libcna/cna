# Audit: src/Microsoft/Xna/Framework/Media/ArtistCollection.cpp

## Metadata
- Source file: `src/Microsoft/Xna/Framework/Media/ArtistCollection.cpp`
...
## Purpose
Pure delegation to `CNA::Internal::Media::MediaCollectionBase<Artist>`.
