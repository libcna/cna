# Audit: src/CNA/Internal/Backends/Vulkan/shaders/skinned3d_color.vert.glsl

## Metadata

- Source file: `src/CNA/Internal/Backends/Vulkan/shaders/skinned3d_color.vert.glsl`
- Audit status: AUDITED
- Subsystem: `backend-vulkan` shard
- File type: GLSL shader source (compiled to SPIR-V via `compile_shaders.py`/`shaderc`)
- XNA/FNA relevance: SkinnedEffect stride-56 (SkinnedVertex+Color, CNB-67) per-pixel-lit vertex shader variant.
...
SkinnedEffect stride-56 (SkinnedVertex+Color, CNB-67) per-pixel-lit vertex shader variant.
