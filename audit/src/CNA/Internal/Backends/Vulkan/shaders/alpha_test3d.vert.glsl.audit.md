# Audit: src/CNA/Internal/Backends/Vulkan/shaders/alpha_test3d.vert.glsl

## Metadata

- Source file: `src/CNA/Internal/Backends/Vulkan/shaders/alpha_test3d.vert.glsl`
- Audit status: AUDITED
- Subsystem: `backend-vulkan` shard
- File type: GLSL shader source (compiled to SPIR-V via `compile_shaders.py`/`shaderc`)
- XNA/FNA relevance: AlphaTestEffect vertex shader (strides 20/32, no color attribute).
...
AlphaTestEffect vertex shader (strides 20/32, no color attribute).
