# Audit: src/CNA/Internal/Backends/Vulkan/shaders/skinned3d.vert.glsl

## Metadata

- Source file: `src/CNA/Internal/Backends/Vulkan/shaders/skinned3d.vert.glsl`
- Audit status: AUDITED
- Subsystem: `backend-vulkan` shard
- File type: GLSL shader source (compiled to SPIR-V via `compile_shaders.py`/`shaderc`)
- XNA/FNA relevance: SkinnedEffect stride-52 per-pixel-lit vertex shader — bone-palette skinning + fog.
...
SkinnedEffect stride-52 per-pixel-lit vertex shader — bone-palette skinning + fog.
