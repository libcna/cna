# Audit: src/CNA/Internal/Backends/SdlGpu/shaders/dual_texture3d.vert.glsl

## Metadata

- Source file: `src/CNA/Internal/Backends/SdlGpu/shaders/dual_texture3d.vert.glsl`
...
- XNA/FNA relevance: DualTextureEffect vertex stage, stride 20
...
Transforms position, forwards UV, sets fragTint = DiffuseColor. Reuses the same 128-byte uniform layout as textured3d/colored3d.
...
### API / XNA parity
Correct, minimal implementation, correctly reusing an existing uniform layout rather than declaring a redundant one.
...
Shares `dual_texture3d.frag.glsl` with `dual_texture_colored3d.vert.glsl`.
...
Efficient uniform-layout reuse.
