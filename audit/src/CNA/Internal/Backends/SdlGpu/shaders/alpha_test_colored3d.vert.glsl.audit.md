# Audit: src/CNA/Internal/Backends/SdlGpu/shaders/alpha_test_colored3d.vert.glsl

## Metadata

- Source file: `src/CNA/Internal/Backends/SdlGpu/shaders/alpha_test_colored3d.vert.glsl`
...
- XNA/FNA relevance: AlphaTestEffect vertex stage, stride 24 (VertexPositionColorTexture, VertexColorEnabled)
...
Transforms position, forwards UV, mixes vertex color with DiffuseColor gated by VertexColorEnabled.
...
### API / XNA parity
Correct VertexColorEnabled gating, consistent with `colored_textured3d.vert.glsl`'s convention.
...
Shares `alpha_test3d.frag.glsl` with `alpha_test3d.vert.glsl`.
