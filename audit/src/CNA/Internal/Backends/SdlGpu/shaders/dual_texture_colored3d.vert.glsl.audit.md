# Audit: src/CNA/Internal/Backends/SdlGpu/shaders/dual_texture_colored3d.vert.glsl

## Metadata

- Source file: `src/CNA/Internal/Backends/SdlGpu/shaders/dual_texture_colored3d.vert.glsl`
...
- XNA/FNA relevance: DualTextureEffect vertex stage, stride 24 (VertexPositionColorTexture, VertexColorEnabled)
...
Shares `dual_texture3d.frag.glsl` with `dual_texture3d.vert.glsl`.
