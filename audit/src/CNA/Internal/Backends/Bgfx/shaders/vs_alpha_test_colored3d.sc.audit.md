# Audit: src/CNA/Internal/Backends/Bgfx/shaders/vs_alpha_test_colored3d.sc

## Metadata

- Source file: `src/CNA/Internal/Backends/Bgfx/shaders/vs_alpha_test_colored3d.sc`
- Audit status: AUDITED
- Subsystem: `backend-bgfx` shard
- File type: BGFX shading language (.sc) source
- XNA/FNA relevance: AlphaTestEffect vertex stage, VertexColorEnabled variant
...
### API / XNA parity
Correct VertexColorEnabled gating, explicitly cross-referenced against `vs_colored_textured3d.sc`'s identical formula.
...
Shares `fs_alpha_test3d.sc` with `vs_alpha_test3d.sc`.
