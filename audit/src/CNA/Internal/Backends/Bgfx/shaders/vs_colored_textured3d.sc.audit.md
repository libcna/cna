# Audit: src/CNA/Internal/Backends/Bgfx/shaders/vs_colored_textured3d.sc

## Metadata

- Source file: `src/CNA/Internal/Backends/Bgfx/shaders/vs_colored_textured3d.sc`
- Audit status: AUDITED
- Subsystem: `backend-bgfx` shard
- File type: BGFX shading language (.sc) source
- XNA/FNA relevance: BasicEffect vertex stage, VertexPositionColorTexture
...
### API / XNA parity
Correct VertexColorEnabled gating, explicitly and accurately cross-referenced against `vs_colored3d.sc`'s own identical formula.
...
Shares `fs_colored_textured3d.sc` (reviewed via `fs_textured3d.sc`'s identical logic).
