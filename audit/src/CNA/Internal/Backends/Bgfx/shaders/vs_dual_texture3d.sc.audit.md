# Audit: src/CNA/Internal/Backends/Bgfx/shaders/vs_dual_texture3d.sc

## Metadata

- Source file: `src/CNA/Internal/Backends/Bgfx/shaders/vs_dual_texture3d.sc`
...
Shares `fs_dual_texture3d.sc` with `vs_dual_texture_colored3d.sc`.
