# Audit: src/CNA/Internal/Backends/Bgfx/shaders/vs_dual_texture_colored3d.sc

## Metadata

- Source file: `src/CNA/Internal/Backends/Bgfx/shaders/vs_dual_texture_colored3d.sc`
- Audit status: AUDITED
- Subsystem: `backend-bgfx` shard
- File type: BGFX shading language (.sc) source
- XNA/FNA relevance: DualTextureEffect vertex stage, VertexColorEnabled variant
...
### API / XNA parity
Correct VertexColorEnabled gating.
...
Shares `fs_dual_texture3d.sc` with `vs_dual_texture3d.sc`.
...
Consistent VertexColorEnabled convention.
