# Audit: src/CNA/Graphics/AsciiPostProcessEffect.cpp

## Metadata

- Source file: `src/CNA/Graphics/AsciiPostProcessEffect.cpp`
- Physical location: `modules/graphics-ext/src/AsciiPostProcessEffect.cpp`
...
Renderer-neutral ASCII/glyph-grid image post-process effect.
