# Audit: src/CNA/Graphics/RenderTargetPool.cpp

## Metadata

- Source file: `src/CNA/Graphics/RenderTargetPool.cpp`
- Physical location: `modules/graphics-ext/src/RenderTargetPool.cpp`
