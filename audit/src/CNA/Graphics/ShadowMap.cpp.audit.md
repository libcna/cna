# Audit: src/CNA/Graphics/ShadowMap.cpp

## Metadata

- Source file: `src/CNA/Graphics/ShadowMap.cpp`
- Physical location: `modules/graphics-ext/src/ShadowMap.cpp`
...
- Plan rows: `MOD-1699`, `MOD-810`, `MOD-811`
