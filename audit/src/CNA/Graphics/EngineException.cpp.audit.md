# Audit: src/CNA/Graphics/EngineException.cpp

## Metadata

- Source file: `src/CNA/Graphics/EngineException.cpp`
- Physical location: `modules/graphics-ext/src/EngineException.cpp`
