# Audit: src/CNA/Graphics/PostProcessChain.cpp

## Metadata

- Source file: `src/CNA/Graphics/PostProcessChain.cpp`
- Physical location: `modules/graphics-ext/src/PostProcessChain.cpp`
