# Audit: src/CNA/Graphics/RenderPipelineSettings.cpp

## Metadata

- Source file: `src/CNA/Graphics/RenderPipelineSettings.cpp`
...
Implements RenderPipelineSettings' pure getter/setter accessors.
...
Trivial, correct pass-through accessors.
