# Audit: src/CNA/Graphics/TonemapPass.cpp

## Metadata

- Source file: `src/CNA/Graphics/TonemapPass.cpp`
- Physical location: `modules/graphics-ext/src/TonemapPass.cpp`
...
Maps a scene-referred HDR image into displayable range, then encodes it for the display.
