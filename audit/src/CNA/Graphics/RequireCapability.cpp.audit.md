# Audit: src/CNA/Graphics/RequireCapability.cpp

## Metadata

- Source file: `src/CNA/Graphics/RequireCapability.cpp`
- Physical location: `modules/graphics-ext/src/RequireCapability.cpp`
