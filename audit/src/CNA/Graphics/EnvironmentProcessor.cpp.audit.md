# Audit: src/CNA/Graphics/EnvironmentProcessor.cpp

## Metadata

- Source file: `src/CNA/Graphics/EnvironmentProcessor.cpp`
- Physical location: `modules/graphics-ext/src/EnvironmentProcessor.cpp`
