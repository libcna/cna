# Audit: src/CNA/Graphics/CRTEffect.cpp

## Metadata

- Source file: `src/CNA/Graphics/CRTEffect.cpp`
- Physical location: `modules/graphics-ext/src/CRTEffect.cpp`
...
Full-screen CRT display emulation post-process effect.
