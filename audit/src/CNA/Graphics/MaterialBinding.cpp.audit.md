# Audit: src/CNA/Graphics/MaterialBinding.cpp

## Metadata

- Source file: `src/CNA/Graphics/MaterialBinding.cpp`
- Physical location: `modules/graphics-ext/src/MaterialBinding.cpp`
