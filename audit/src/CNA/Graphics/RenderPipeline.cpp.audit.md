# Audit: src/CNA/Graphics/RenderPipeline.cpp

## Metadata

- Source file: `src/CNA/Graphics/RenderPipeline.cpp`
- Physical location: `modules/graphics-ext/src/RenderPipeline.cpp`
