# Audit: src/CNA/Graphics/ComputeShader.cpp

## Metadata

- Source file: `src/CNA/Graphics/ComputeShader.cpp`
- Physical location: `modules/graphics-ext/src/ComputeShader.cpp`
...
- Plan rows: `MOD-1524`, `MOD-2228`, `MOD-2229`
