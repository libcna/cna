# Audit: src/CNA/Graphics/EngineLayerVersion.cpp

## Metadata

- Source file: `src/CNA/Graphics/EngineLayerVersion.cpp`
- Physical location: `modules/graphics-ext/src/EngineLayerVersion.cpp`
