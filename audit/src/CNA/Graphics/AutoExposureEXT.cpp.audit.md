# Audit: src/CNA/Graphics/AutoExposureEXT.cpp

## Metadata

- Source file: `src/CNA/Graphics/AutoExposureEXT.cpp`
- Physical location: `modules/graphics-ext/src/AutoExposureEXT.cpp`
