# Audit: src/CNA/Graphics/PostProcessPass.cpp

## Metadata

- Source file: `src/CNA/Graphics/PostProcessPass.cpp`
- Physical location: `modules/graphics-ext/src/PostProcessPass.cpp`
