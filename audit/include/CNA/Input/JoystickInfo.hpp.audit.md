# Audit: include/CNA/Input/JoystickInfo.hpp

## Metadata

- Source file: `include/CNA/Input/JoystickInfo.hpp`
...
Declares JoystickInfoEXT: identity (id + name + type) of one enumerated raw joystick device.
...
Minimal, correct struct with a complete equality operator.
