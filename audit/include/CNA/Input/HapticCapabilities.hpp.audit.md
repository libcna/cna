# Audit: include/CNA/Input/HapticCapabilities.hpp

## Metadata

- Source file: `include/CNA/Input/HapticCapabilities.hpp`
...
Declares HapticCapabilitiesEXT: the static hardware shape of an opened haptic device (name, supported feature bitmask, axis count, max effects, rumble support).
...
Complete, correct struct with an exhaustive field-by-field equality operator.
