# Audit: include/CNA/Graphics/GltfMaterialBridge.hpp

## Metadata

- Source file: `include/CNA/Graphics/GltfMaterialBridge.hpp`
- Physical location: `modules/graphics-ext/include/CNA/Graphics/GltfMaterialBridge.hpp`
...
- Plan rows: `MOD-1305`, `MOD-1309`, `MOD-1310`

## Purpose

The textures an imported material's slots resolve to, in `PbrTextureSlot` order.
