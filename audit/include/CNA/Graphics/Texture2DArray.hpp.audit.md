...
Immutable descriptor, usage declaration and tracked public resource for sampled two-dimensional
texture arrays.

## Executive Verdict

Not yet independently audited. This work-queue entry was added with `MOD-2225`; the implementation
landed with focused public-contract tests and a false-by-default renderer factory.
