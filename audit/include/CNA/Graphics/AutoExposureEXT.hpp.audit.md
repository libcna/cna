# Audit: include/CNA/Graphics/AutoExposureEXT.hpp

## Metadata

- Source file: `include/CNA/Graphics/AutoExposureEXT.hpp`
- Physical location: `modules/graphics-ext/include/CNA/Graphics/AutoExposureEXT.hpp`
...
- Plan rows: `MOD-1552`, `MOD-308`

## Purpose

Measures a frame's average luminance on the GPU and turns it into an exposure.
