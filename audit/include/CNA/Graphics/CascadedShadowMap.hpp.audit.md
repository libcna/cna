# Audit: include/CNA/Graphics/CascadedShadowMap.hpp

## Metadata

- Source file: `include/CNA/Graphics/CascadedShadowMap.hpp`
- Physical location: `modules/graphics-ext/include/CNA/Graphics/CascadedShadowMap.hpp`
...
- Plan rows: `MOD-903`, `MOD-904`, `MOD-907`

## Purpose

A directional shadow map split into several depth ranges, so that a large scene keeps usable shadow resolution near the camera.
