...
- XNA/FNA relevance: N/A -- NOXNA, feeds real
  `Microsoft::Xna::Framework::Media::MediaPlayer::GetVisualizationData` (plan_media.md MEDIA-186)
...
prior external code review (plan_media.md MEDIA-216) for the "relaxed atomic float lowers to a plain
