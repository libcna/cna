# Audit: include/CNA/Internal/Input/SystemSensorBackend.hpp

## Metadata

- Source file: `include/CNA/Internal/Input/SystemSensorBackend.hpp`
...
Declares ISystemSensorBackend: an injectable seam over SDL3's host-device motion-sensor API, used by CNA::Input::Sensors.
