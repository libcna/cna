# Audit: include/CNA/Internal/Backends/D3D9/D3D9ProfileCapabilities.hpp

## Metadata

- Source file: `include/CNA/Internal/Backends/D3D9/D3D9ProfileCapabilities.hpp`
- Audit status: AUDITED
- Subsystem: `backend-d3d9` shard
- File type: C++ header
- XNA/FNA relevance: Declares the real GraphicsProfile.Reach/HiDef capability-tier query/enforcement functions.
...
Declares the real GraphicsProfile.Reach/HiDef capability-tier query/enforcement functions.
...
Clean declaration; see the `.cpp` report for the genuinely authentic profile-tier implementation.
