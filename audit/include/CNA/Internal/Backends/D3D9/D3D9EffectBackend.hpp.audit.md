# Audit: include/CNA/Internal/Backends/D3D9/D3D9EffectBackend.hpp

## Metadata

- Source file: `include/CNA/Internal/Backends/D3D9/D3D9EffectBackend.hpp`
- Audit status: AUDITED
- Subsystem: `backend-d3d9` shard
- File type: C++ header
- XNA/FNA relevance: Declares D3D9EffectBackend — custom (non-stock) Effect support via runtime D3DCompile().
...
Declares D3D9EffectBackend — custom (non-stock) Effect support via runtime D3DCompile().
...
Clean declaration; see the `.cpp` report for the implementation review.
