# Audit: include/CNA/Internal/Backends/D3D9/D3D9OcclusionQuery.hpp

## Metadata

- Source file: `include/CNA/Internal/Backends/D3D9/D3D9OcclusionQuery.hpp`
- Audit status: AUDITED
- Subsystem: `backend-d3d9` shard
- File type: C++ header
- XNA/FNA relevance: Declares D3D9OcclusionQueryBackend — a real IDirect3DQuery9 (D3DQUERYTYPE_OCCLUSION) wrapper.
...
Declares D3D9OcclusionQueryBackend — a real IDirect3DQuery9 (D3DQUERYTYPE_OCCLUSION) wrapper.
...
Clean declaration; see the `.cpp` report for a genuine positive structural contrast with D3D12's own confirmed multi-draw occlusion-query bug.
