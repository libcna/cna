# Audit: include/CNA/Internal/Backends/D3D9/D3D9StateMapping.hpp

## Metadata

- Source file: `include/CNA/Internal/Backends/D3D9/D3D9StateMapping.hpp`
- Audit status: AUDITED
- Subsystem: `backend-d3d9` shard
- File type: C++ header
- XNA/FNA relevance: Declares the XNA Blend/BlendFunction/CompareFunction/CullMode/FillMode/StencilOperation/TextureAddressMode/TextureFilter -> D3D9 enum mapping functions.
...
Declares the XNA Blend/BlendFunction/CompareFunction/CullMode/FillMode/StencilOperation/TextureAddressMode/TextureFilter -> D3D9 enum mapping functions.
...
Clean declaration; see the `.cpp` report for the complete, correct mapping tables.
