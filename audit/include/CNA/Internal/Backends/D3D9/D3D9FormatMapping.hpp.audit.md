# Audit: include/CNA/Internal/Backends/D3D9/D3D9FormatMapping.hpp

## Metadata

- Source file: `include/CNA/Internal/Backends/D3D9/D3D9FormatMapping.hpp`
- Audit status: AUDITED
- Subsystem: `backend-d3d9` shard
- File type: C++ header
- XNA/FNA relevance: Declares SurfaceFormatToD3D9()/DepthFormatToD3D9() — XNA format -> D3DFORMAT mapping.
...
Declares SurfaceFormatToD3D9()/DepthFormatToD3D9() — XNA format -> D3DFORMAT mapping.
...
Clean declaration; see the `.cpp` report for the mapping's own careful bit-layout verification.
