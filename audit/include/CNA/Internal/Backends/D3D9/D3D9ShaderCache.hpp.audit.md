# Audit: include/CNA/Internal/Backends/D3D9/D3D9ShaderCache.hpp

## Metadata

- Source file: `include/CNA/Internal/Backends/D3D9/D3D9ShaderCache.hpp`
- Audit status: AUDITED
- Subsystem: `backend-d3d9` shard
- File type: C++ header
- XNA/FNA relevance: Declares D3D9ShaderCache — a name-keyed cache over the embedded, pre-compiled stock-effect SM2 bytecode.
...
Declares D3D9ShaderCache — a name-keyed cache over the embedded, pre-compiled stock-effect SM2 bytecode.
