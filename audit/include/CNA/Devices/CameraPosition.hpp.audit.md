# Audit: include/CNA/Devices/CameraPosition.hpp

## Metadata

- Source file: `include/CNA/Devices/CameraPosition.hpp`
...
Declares CameraPosition: front/back-facing/unknown, mirroring SDL3's SDL_CameraPosition.
...
Minimal, correct enum; every value has a corresponding case in `Camera.cpp`'s own conversion switch.
