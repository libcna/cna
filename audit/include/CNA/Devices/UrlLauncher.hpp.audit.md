# Audit: include/CNA/Devices/UrlLauncher.hpp

## Metadata

- Source file: `include/CNA/Devices/UrlLauncher.hpp`
...
Declares UrlLauncher: opens a URL/URI in the system's default external application, backed by SDL3's SDL_OpenURL.
...
Correctly documents SDL3's own caveat that success means only that something was launched, not that it actually loaded, and that opening a URL may cause the game window to lose focus/background.

### Testing
Has dedicated tests: `tests/CNA/Devices/UrlLauncherTests.cpp`.
