# Audit: include/CNA/Devices/Detail/ITrayBackend.hpp

## Metadata

- Source file: `include/CNA/Devices/Detail/ITrayBackend.hpp`
...
Declares ITrayBackend (the swappable-backend interface SystemTray calls through) and TrayEntryClickCallback.
...
Clean interface; correctly documents the deliberate flat-menu-only scope (no `SDL_CreateTraySubmenu()` wrapping) as a reasonable first-implementation limit, not an oversight.
