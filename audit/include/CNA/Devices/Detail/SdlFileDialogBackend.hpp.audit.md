# Audit: include/CNA/Devices/Detail/SdlFileDialogBackend.hpp

## Metadata

- Source file: `include/CNA/Devices/Detail/SdlFileDialogBackend.hpp`
...
Declares SdlFileDialogBackend: the real IFileDialogBackend implementation over SDL3's async dialog API.
...
Clean declaration; see the `.cpp` report for the careful async-callback-lifetime management verified there.
