# Audit: include/CNA/Devices/FileDialogFilter.hpp

## Metadata

- Source file: `include/CNA/Devices/FileDialogFilter.hpp`
...
Declares FileDialogFilter: one file-type filter entry (label + semicolon-separated extension pattern), mirroring SDL3's SDL_DialogFileFilter.
...
Minimal, correct struct with accurate documentation of the extension-pattern character-set constraint.
