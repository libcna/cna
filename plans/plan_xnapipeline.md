...
```text
CnaContentTests:          1711 run   1613 passed   68 skipped   30 failed
CnaContentPipelineTests:    37 run     37 passed    0 skipped    0 failed
CnaTests (whole suite):   7843 run   7302 passed  512 skipped   29 failed
```

`CnaContentTests` shows the same 30 environmental failures as the recorded baseline, +96 tests,
+126 passing, **zero new failures**. `CnaContentPipelineTests` is the new build-time module's own
