...
three items whose own task text says to measure before implementing (`CNBF-108` mmap) or that belong to a different project (`CNBF-107` `.cnapak`), and one internal
refactor, `CNBF-106B`.
