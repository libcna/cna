...
**Implementation under way.** Seventeen tasks are ✅ (`VULKAN-004`, `-020`, `-021`, `-091`, `-097`,
`-130`, `-131`, `-145`, `-146`, `-147`, `-148`, `-250`, `-332`, `-333`, `-346`, `-370`, `-390`), plus
...
it) — plus the `VULKAN-145`–`VULKAN-149` split of `VULKAN-144` and F-21's correction to the
baseline itself.

**The Vulkan suite is 225/226** on `-R '^Vulkan_'`, from the 209/215 this plan opened with, and the
full `ctest` is **9063/9082**. §7.5 carries the running baseline, one line per
