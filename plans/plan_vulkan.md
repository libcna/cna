...
**Implementation under way.** Sixteen tasks are ✅ (`VULKAN-004`, `-020`, `-021`, `-091`, `-097`,
`-130`, `-131`, `-145`, `-146`, `-147`, `-250`, `-332`, `-333`, `-346`, `-370`, `-390`), plus
...
`Vector4`-spelled `BlendIndices` is bindable on EasyGL and not here) — plus the
...
full `ctest` is **9060/9082**. §7.5 carries the running baseline, one line per
