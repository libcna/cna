...
**Implementation under way.** Nineteen tasks are ✅ (`VULKAN-004`, `-020`, `-021`, `-091`, `-097`,
`-130`, `-131`, `-144`, `-145`, `-146`, `-147`, `-148`, `-149`, `-250`, `-332`, `-333`, `-346`, `-370`,
`-390`), plus
...
legacy `DrawColoredPrimitives` pair binds a hard-coded stride) — plus the
...
full `ctest` is **9060/9083**. §7.5 carries the running baseline, one line per
