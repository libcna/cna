...
> battery state from Linux, and X11-0164, the clipboard handed to a clipboard manager at exit, are
> ✅; X11-0165..0166 are ⬜. See
...
| X11-0165 | Input-device enumeration through XInput2 | ⬜ | `inputDeviceEnumeration` is false; XI2 can answer it. |
| X11-0166 | Gamepad motion sensors | ⬜ | A pad's sensors are a second evdev node to pair with it. |
---
