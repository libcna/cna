...
> `SkinnedEffect` classic lighting, Texture3D,
...
- After `SOFTWARE-114`, the complete `Software` label run is 71 passed, four existing MSAA/
  ...
  and eleven pre-existing EasyGL EnvironmentMap binaries pass 23/23 under Xvfb. Ten affected
