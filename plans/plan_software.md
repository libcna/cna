...
> RenderTargetCube, MRT and instancing. The executable task table is in the new parity campaign
...
anisotropic sampling and its SpriteBatch plumbing. Remaining resource tasks `SOFTWARE-119..120` precede the high-level
