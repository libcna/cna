...
`SOFTWARE-104`, `SOFTWARE-105`, `SOFTWARE-106` and `SOFTWARE-108` are complete foundations.
`SOFTWARE-108` unlocks correct dual-UV and arbitrary input work. `SOFTWARE-107/110/121` establish fragment correctness
