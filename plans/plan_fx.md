...
2026-08-18 closure pass added Vulkan, `FX-063` added DirectX 11 on 2026-09-09, and `FX-134` added
DirectX 12 on 2026-09-10. `FX-070` added DirectX 9 through the executable MinGW/Wine+DXVK loop on
the same day. Only Metal remains, and it requires macOS. Writing any backend blind behind a
capability gate remains forbidden -- a backend is promoted on executed evidence or not at all.
