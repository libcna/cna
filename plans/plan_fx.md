...
skips, smoke is 62/62, and its initial complete-label gate was 45/54. Subsequent fixes `D9-125` and
`D9-126` make the current label 51/54 with three genuine renderer failures.
