...
* Song compilation records and encodes the streaming media XREF but the current one-output builder
  does not copy that media into the output tree. Deployment must place it at the referenced path;
