...
// Minimal-link probe for CNA::Runtime (MODULARIZATION_PLAN.md §4): the Game layer's symbols
// must resolve without GamerServices/Net, devices or NOXNA. Referencing Game's members pulls
