...
// stream carries its whole public offset and the backend owes it at bind time. This backend's
...
protected:
    ...
    void SetUp() override
    {
        ...
        // winding -- a default-culled quad reads exactly like "the backend drew nothing", so the
