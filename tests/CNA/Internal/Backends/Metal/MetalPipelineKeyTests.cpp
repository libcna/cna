...
// the rest of the Metal backend (Objective-C++, only ever compiled on a real Mac), this test
// compiles and runs on every platform CnaTests already builds for -- no #if defined(CNA_BACKEND_*)
