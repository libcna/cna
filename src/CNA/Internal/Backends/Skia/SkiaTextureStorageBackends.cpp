...
namespace CNA::Internal::Backends::Skia
{
    ...
    SkiaTextureCubeBackend::SkiaTextureCubeBackend(
    ...
    bool SkiaTextureCubeBackend::SetData(int face, int level, int x, int y,
    ...
    bool SkiaTextureCubeBackend::GetData(int face, int level, int x, int y,
                                         int width, int height,
    ...
    SkiaTexture3DBackend::SkiaTexture3DBackend(
    ...
    bool SkiaTexture3DBackend::SetData(int level, int x, int y, int z,
    ...
    bool SkiaTexture3DBackend::GetData(int level, int x, int y, int z,
                                       int width, int height, int depth,
                                       void* data, int dataLength) const
    {
        if (!data || level < 0 || level >= static_cast<int>(levels_.size()))
