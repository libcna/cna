...
// SkinnedEffect.VertexColorEnabled fragment shader, OpenGL flavour. LLGL-37. See
// skinned3d_color.frag.glsl for the Vulkan flavour, the lighting equation, and the vertex-colour
// gate/modulation order this mirrors exactly.
