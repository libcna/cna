...
namespace CNA::Internal::Backends::Bgfx
{
    ...
    std::unique_ptr<IRenderTargetCubeBackend> BgfxGraphicsBackend::CreateRenderTargetCube(int size, int depthFormat, bool preserveContents, bool mipMap, int multiSampleCount)
    {
        // REMED-GFX-136: consumed by being deliberately unused. A bgfx view only clears what
        // setViewClear() tells it to, and this backend leaves every render-target view at
    ...
    void BgfxGraphicsBackend::FinalizeCurrentCubeFaceEXT()
    {
