...
// CNA_Canvas2D_ReadCurrentPixels in CanvasGraphicsBackend.cpp, which reads whichever context is
...
namespace CNA::Internal::Backends::Canvas
{
    ...
    bool CanvasRenderTargetBackend::GetData(int level, int x, int y, int w, int h,
                                            void* data, int dataLength) const
    {
        ...
        if (level > 0)
            throw System::NotSupportedException(
                "CanvasRenderTargetBackend::GetData: Canvas2D has no mip chain; level " +
