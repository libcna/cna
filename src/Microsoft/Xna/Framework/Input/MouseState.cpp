...
{
    IMPL_PROP(ButtonState, LeftButton, getter1, setter0, member0, static0, constret1, ref1, constmet1, MouseState,
              nothing)
    IMPL_PROP(ButtonState, RightButton, getter1, setter0, member0, static0, constret1, ref1, constmet1, MouseState,
              nothing)
    IMPL_PROP(ButtonState, MiddleButton, getter1, setter0, member0, static0, constret1, ref1, constmet1, MouseState,
              nothing)
    ...
    IMPL_PROP(int, ScrollWheelValue, getter1, setter0, member0, static0, constret1, ref1, constmet1, MouseState,
              nothing)
