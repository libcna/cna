...
| Files referencing SDL (all) | **586** |
| Production files (`src/` + `include/`) referencing SDL | **263** |
...
|---|---:|---|
| `modules/input` | 43 | keyboard, mouse, gamepad, joystick, haptic, sensor, touch, text input |
