...
wine "$WINEPREFIX/drive_c/windows/Microsoft.NET/Framework/v4.0.30319/csc.exe" \
  /nologo /platform:x86 /target:exe /out:XnaSpriteBatchSampler0Probe.exe \
  ...
  XnaSpriteBatchSampler0Probe.cs || { echo "BUILD FAILED"; exit 1; }

echo "--- built, running ---"
wine ./XnaSpriteBatchSampler0Probe.exe
