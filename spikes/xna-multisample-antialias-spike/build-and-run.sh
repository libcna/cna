...
wine "$WINEPREFIX/drive_c/windows/Microsoft.NET/Framework/v4.0.30319/csc.exe" \
  /nologo /platform:x86 /target:exe /out:XnaMultiSampleAntiAliasProbe.exe \
  ...
  XnaMultiSampleAntiAliasProbe.cs || { echo "BUILD FAILED"; exit 1; }

echo "--- built, running ---"
wine ./XnaMultiSampleAntiAliasProbe.exe
