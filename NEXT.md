...
| Confirmed bug, not fixed | `SkinnedEffect` has zero specular implementation; `WeightsPerVertex` is a GPU no-op. | 894/895 |
...
2. ~~Fix Task 890~~ / ~~Task 893~~ — **both done**, see §3. **Fix Task 894/895** (`SkinnedEffect`
