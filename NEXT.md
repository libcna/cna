...
| Status | # | Description |
|--------|---|-------------|
| ✅ done | 151–160, 166–170 | SpriteBatch stub removal, guard fixes, SpriteEffects flip, transformMatrix, Texture2D partial rect + startIndex |
| **next** | **171** | **Texture2D mip-level SetData/GetData** |
