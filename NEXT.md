...
Task 671 is already done from an earlier session (SpriteBatch rotation) — continue at Task 679 (Tasks 672-678 also done this session, see §3).
...
continue at Task 679), and/or the untriaged 421–500 range of
...
already done from an earlier session — continue at Task 679 — write pixel tests for
