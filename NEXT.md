...
## C BINDING / C ABI — B4 2D VERTICAL SLICE UNDERWAY (2026-08-14)
...
> API** through C-native mappings. `CBIND-001`–`024` are complete: `docs/c-api/` defines the
...
> fixed default XNA state, retained texture lifetime and cancel-safe destruction. Input snapshots
> follow; the coverage matrix remains the guard against omitted public CNA symbols.
