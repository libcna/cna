...
a UBSan scratchpad build), and Task 706 confirmed `DiscardContents`/`PreserveContents` are
genuinely different (no bug found) — continue at Task 707, and/or the untriaged 421–500 range of
...
scratchpad build), and Task 706 confirmed `DiscardContents`/`PreserveContents` are genuinely
different (no bug found) — continue at Task 707 — write pixel tests for
