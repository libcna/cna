...
Task 671 is already done from an earlier session (SpriteBatch rotation) — continue at Task 681 (Tasks 672-680 also done this session, see §3).
...
continue at Task 681), and/or the untriaged 421–500 range of
...
already done from an earlier session — continue at Task 681 — write pixel tests for
