...
| Confirmed bug, not fixed | `SkinnedEffect`'s `WeightsPerVertex` is a GPU no-op. | 895 |
...
2. ~~Fix Task 890~~ / ~~Task 893~~ / ~~Task 894~~ — **all three done**, see §3. **Fix Task 895**
   (`SkinnedEffect.WeightsPerVertex` GPU no-op — same family as the now-closed Tasks 889/890/891/
   893/894, see §2 "Does NOT work yet").
