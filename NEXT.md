...
`RenderTarget2D` by unconditionally clearing a nonexistent depth buffer on bind) — continue at
Task 705, and/or the untriaged 421–500 range of
...
unconditionally clearing a nonexistent depth buffer on bind) — continue at Task 705 — write pixel tests for
