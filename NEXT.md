...
different, and Task 707 confirmed `GetBackBufferData` genuinely reads the real backbuffer after
unbinding (both no bugs found) — continue at Task 708, and/or the untriaged 421–500 range of
...
different, and Task 707 confirmed `GetBackBufferData` genuinely reads the real backbuffer after
unbinding (both no bugs found) — continue at Task 708 — write pixel tests for
