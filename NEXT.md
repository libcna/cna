...
except BLOCKED 686/687 (see §5), the entire SpriteFont section (690-694) is also done, and the
entire BlendState section (695-700) is now done (Task 695 found+fixed 2 real bugs) — continue at
Task 701 (SamplerState section), and/or the untriaged 421–500 range of
...
(695-700) are also fully done (Task 695 found+fixed 2 real bugs) — continue at Task 701 — write pixel tests for
