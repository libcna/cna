...
test's own call pattern rather than production code) — continue at Task 712, and/or the untriaged 421–500 range of
...
under X11, fixed the test's own call pattern rather than production code) — continue at Task 712 — write pixel tests for
