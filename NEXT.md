...
## Repo state as of 2026-07-08 (end of Task 903 session) — READ THIS FIRST
...
unverifiable — needs a real `bgfx::readTexture()` readback path first). Next up: whatever the
project owner scopes for the remaining decision-blocked items (Task 902/910/911/914, all need
their own dedicated scoping pass), or the older, not-yet-triaged backlog below Task 900 in
